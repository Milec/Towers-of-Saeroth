...
![Portrait of Zombie Shambler](Zombie%20Shambler%20portrait.png)

Mud weighs down its torn clothes. It drags one foot through the ditch, then
reaches for the nearest living person.

The ordinary shambler used alongside [[Kindled Shambler]] in
[[Session 01 — The Berruel Consignment]]. Statistics follow Zombie Shambler,
*Monster Core*, page 356; the appearance belongs to this encounter.
...
Rules reference: [Zombie Shambler on Archives of Nethys](https://2e.aonprd.com/Monsters.aspx?ID=3249).
