...
Once in a long while a child is born carrying a spark of divine power, and no
god will say whose it is.

They are not clerics, not oracles, not chosen and not descended from anybody.
No temple ordains them, no revelation precedes them, no lineage predicts them.
The spark is simply present, from birth, in a child otherwise indistinguishable
...
An exemplar's divinity works through **ikons**: objects or features of the body
that the spark can live inside. A spear. A crown. A scar. A voice. The item is
not enchanted in any conventional sense and no magic can be detected in it
until the spark is in it, at which point it is unambiguously, embarrassingly
divine.

This is the part that makes exemplars a political problem rather than a
curiosity. An ikon is a holy object with no church behind it, and there are
...
- **No church can vouch for you and no church can excommunicate you**, which
  cuts in both directions in a world with a Cathedral Court in it.
- **Divination gets a straight answer about everything except you.** Where the
  spark came from returns nothing — not a refusal, not a lie, not a warning.
  Silence, from every god asked.
...
The same trace turns up in objects as well as in people — relics that are
genuinely divine and belong to no faith, no saint and no recorded miracle.
They are rare, they are old, they are exceptionally valuable, and no church in
Saeroth has ever produced a convincing account of where they come from.

The relic trade knows this and does not advertise it. A certificate from
Dalstan's Cathedral Court establishes provenance to a saint. It establishes
