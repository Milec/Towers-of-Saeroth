...
The ritual was too far along to simply unwind — an empire cannot be handed
...
- **The sorcerer-kings were not killed.** Killing them ends a mortal life
  ...
  tried. Instead each was bound — memory stripped, name unmade, mortality
  restored — into a seed of the ritual's own working, sealed shut and set
  down somewhere on the world they used to own. **Those seeds are the
...
- **Nothing was left standing that could try again.** No successor, no
  apprentice, no surviving book. The erasure took the empire's own name
  along with everything else — nobody who resettled the world afterward
  inherited so much as a rumor to work from, which is the entire point. A
  working like this cannot be attempted twice if nobody left alive knows it
  was attempted once.

## What that means for the table

- **A conquered tower's "master" is real, and it is one of them.** The
  rumor that reaching the top makes you rich and titled is not a lie — it
...
- **Pitch is personality, not difficulty.** Every tower answers differently
  ...
  place. This never needs to be said at the table — it is simply *why* the
  fixed relation described in [[The Towers]] holds the way it does, and it
