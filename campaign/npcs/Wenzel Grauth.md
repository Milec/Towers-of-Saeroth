...
Reskin of **Mage For Hire** (`Bestiary/Mage For Hire (NPC Core)`, level 3) —
the numbers below are that published block unchanged; only the name and the
flavour of the spell list are Grauth's.
...
**Skills** Arcana +9, Medicine +5, Occultism +9, Society +7, Stealth +7
...
**Arcane Prepared Spells** DC 20, attack +10; **2nd** false vitality,
mirror image, spectral hand; **1st** grim tendrils, mystic armor, summon undead;
**Cantrips (2nd)** electric arc, message, shield, telekinetic projectile

**Grave-Cut Raising** (concentrate, manipulate) Grauth spends a minute over a
...
level 1 party on his own. See*
*[[Session 01 — The Berruel Consignment]] for how to use him at that level, and
for the variant if your table wants him fought anyway.*
