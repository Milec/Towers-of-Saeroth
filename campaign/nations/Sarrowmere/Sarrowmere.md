...
grew up around the fen-physicians who learned which of the mere's plants heal
and which kill. Being one guild, they learned both at once. Sarrowmere sells
the finest medicines in the world and has never once convinced anybody that
it does not also sell the other thing. The cantons find the suspicion useful.
They resent it at the same time, and see no contradiction in that.
...
- **Capital** Ilmen Wharf, a town built entirely on pilings, where the guildhalls float and are moored rather than founded
...
- **Tension** A canton has begun selling a compound it will only describe as a "sleeping draught", and the other ten have discovered they have no mechanism to make it stop
...
- **Relations** — in brief; every tie in full, and the web, are in [[Political Relations]]
    - [[Thesal Theocracy]] — **Friendly**: The two nations that everyone sends their dying to. …
    - [[Kelvary March]] — **Trade**: Field surgeons, antitoxins and the cultured moulds that stop a camp wound going bad. …
    - [[Quivar]] — **Trade**: Antitoxins to a court that poisons, in the quantities that implies, invoiced quarterly and never discussed
    - [[Melisor Magocracy]] — **Rivalry**: Physic against alchemy. …
    - [[Voskreld Union]] — **Friction**: Voskreld's canal works are draining the eastern fen, cant by cant. …
    - [[Lazarian Lichdom]] — **Covert**: The fen cantons buy reagents no living nation will admit a use for, and the Lichdom is the only supplier. …
