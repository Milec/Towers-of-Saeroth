...
currently conducting, and the Lichdom is quietly being run by a court that
has learned not to ask when he'll be finished.

- **Want** To recover the source of that power in person — not have it
  found and reported to him, *found*, which is why he has never once sent
  an expedition he did not personally brief and does not personally debrief.
- **Won't** Let anyone else get there first, which is the one thing that
  would make him move faster than a decade of patient research otherwise
  requires.
- **Where he's looking** Mostly [[The Wildlands]], where whatever he's
  chasing is thickest on the ground. His agents have also quietly worked a
  handful of far rarer ruins scattered across the settled continents — each
  one identified, excavated, and then gone from local record within a
  season of his interest in it, which is the only pattern anyone outside
  the Cathedral Court has ever managed to notice.

Nothing he has found connects his search to the towers. He has not made
that connection either, yet — and a GM should decide deliberately, not by
accident, the session he does.
