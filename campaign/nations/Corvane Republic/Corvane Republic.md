...
- **Relations**
    ...
    - [[Elven Confederacy]] — **Friendly**: The only neighbour that ever wrote it down: the Republic's charter recognises tribal timber title, which cost Corvane its cheapest lumber and bought it the one border in the north it has never had to garrison
    ...
    - [[Tessine]] — **Friendly**: Two harbours that take anyone, for opposite reasons — one out of principle and one out of profit — and both of them full of people Dalstan wants back
    - [[Aquoniti]] — **Trade**: Corvane hulls for Aquoniti pearls, and a shared professional interest in what the Merchant Alliance is doing next
    - [[Nordheim]] — **Trade**: Nordheim timber and amber into the Vantry yards, Corvane hulls back north. The single busiest stretch of water in the northern west
    - [[Kelvary March]] — **Rivalry**: Two underwriting markets bidding to insure the same cargoes and the same regiments, and each publishing tables proving the other's rates are reckless
    - [[Thurion Merchant Alliance]] — **Rivalry**: Shipbuilders against shippers: Corvane builds better hulls than it can afford to sail, and the Alliance sails better than it builds
    ...
    - [[Dalstan]] — **Hostile**: The Republic shelters everyone the Cathedral Court wants back, publishes their accounts of what was done to them, and shares a border with the nation it is doing this to
