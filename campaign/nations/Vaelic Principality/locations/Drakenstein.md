...
[[Lazarian Lichdom]], and the Order has never pretended the fortress is
oriented any other way or for any other reason.

- **Tenure** Imperial ground, granted out of the Crown's own holdings at the
  founding and never any elector's. This is the whole structural reason the
  Order answers up its own chain rather than to a landlord — the chapter-house
  aeries scattered on electors' territory are the compromise, and Drakenstein
  is the thing the compromise was made to protect
- **Garrison** Two Wings in rotation, roughly seventy-five riders, plus the
  Fledglings in training and rather more grooms, smiths, herders and cooks than
  anyone quite counts. The drakes eat what the eastern valleys can raise, which
  is why the valleys are grazed and not ploughed
- **The Trial** Every three years, thirty to fifty candidates aged eight to
  twelve come up the switchbacks. Most go back down. Commoner and elector's son
