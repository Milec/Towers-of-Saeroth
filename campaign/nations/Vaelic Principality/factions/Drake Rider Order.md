...
The first High Prince was already a prince of a renowned house before he
...
| Rank | Age / Stage | Status | Living at any time |
| --- | --- | --- | --- |
| Trial Candidate | 8–12, pre-bond | Common | ~150–250 per Trial cycle; most don't bond |
| Fledgling Rider | 12–16, ~4-year training | Imperial Ward | ~55–65 |
| Field Rider | 16–18+, ~2-year first assignment | Imperial Ward, active duty | ~25–35 |

At Field Rider's end, a rider enters the standing Order proper: roughly
**375 riders** at any given time, sustained by the same 15/yr accession
rate against a ~25-year further career. Organized into **10 Wings** of
~38 riders each — 1 Wing Marshal, 3 Squad Leaders, 9 Fireteam Leaders, and
the rest as line riders with no command billet.

### Command Track — advancement requires an open seat

| Rank | Commands | Requirement | Status | Living at any time |
| --- | --- | --- | --- | --- |
| Fireteam Leader | Fireteam (3–4 riders) | Open billet + record | Imperial Ward | ~85–95 |
| Squad Leader | Squad (~10–14 riders) | Open billet, from proven Fireteam Leaders | Esquire | ~28–32 |
| Wing Marshal | Wing (~38 riders) | Open Wing command | Knighted | ~9–11, one per Wing |
| Grand Marshal | The whole Order | The single open seat | Comital | 1 |

### Merit Track — no billet required, ever

Each rank is a standard met, not a seat waited for:

- **Marked Rider** — one individually recognized feat: a confirmed solo kill, a named act of valor, a mission no one else could have pulled off. (~85–95 living)
- **Veteran Rider** — a sustained distinguished record across multiple campaigns and years. (~40–50)
...
eyes of the electors who have to live with the choice.

### Status ladder

| Status | First reached at | Grants |
| --- | --- | --- |
| Common | — | No legal change yet |
| Imperial Ward | Fledgling Rider | Precedence over commoners, right to bear arms, Imperial-law protection — no peerage |
| Esquire | Squad Leader / Storied Rider | Personal device, land-grant eligibility — still not full peerage |
| Knighted | Wing Marshal / Knight-Rider | Full personal nobility regardless of birth |
| Comital | Grand Marshal | Outranks ordinary knighthood, reflecting the standing Diet seat |
