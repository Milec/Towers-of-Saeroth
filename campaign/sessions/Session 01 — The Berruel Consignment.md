...
- [[Melisor Magocracy]] is funding an expedition to a tower nobody has
...
- [[Cassian Merovel]] of Melisor supplies the means and takes half the
  ...
  over for twice.
- Neither of them wants to be seen anywhere near it, so the actual work is done
  by [[Wenzel Grauth]], a hedge-necromancer living on ground nobody administers.

**And the frame is already built.** The wagons are attacked by walking dead
within sight of the Lichdom's frontier. Nobody will investigate that. Everyone
already believes it. The claim will be paid in six weeks.

The party are the only witnesses that the dead came from the wrong direction.

## Running it

**The road.** Four days out of [[Quivar]] on the last leg of the Uplad horse
road, the country empties out: this is the tri-point where Quivar, the
[[Vaelic Principality]] and the [[Lazarian Lichdom]] all meet, and none of the
...
- A Melisor reagent flask, empty, thrown into the brush upslope — the kind an
  ...
  say was planted, and they will be half right, because Grauth was told to
  leave it.)
- The consignment manifest, if it survives, is countersigned by a Tessine
...
- [[Thurion Merchant Alliance]]'s standing tension is a great house
  over-exposed on policies it cannot cover. This names it: [[Casa Berruel]].
- [[Tessine]] and Thurion are already rivals — two money markets in one sea.
  This is the rivalry becoming a crime.
- Thurion's patron is [[Abadar]], god of contracts and honest wealth. Insurance
  fraud is not merely a crime in Thurion; it is heresy in its own state cult,
  and an Abadaran who works it out has to act. That is a lever the party can
  pull without a single sword.
- The [[Lazarian Lichdom]] is being framed for something it did not do, which
  is the first time in the setting that anyone has needed it innocent.
