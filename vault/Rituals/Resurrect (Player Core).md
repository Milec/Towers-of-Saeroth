...
**Traits** [[Traits/Uncommon (Player Core)|Uncommon]], [[Traits/Healing (Player Core)|Healing]]

**Source** [[Sources/Player Core]] pg. 394

_[**PFS Note**](https://2e.aonprd.com/pathfinder-society) All characters have access to resurrect_
...
**Primary Check**  [[Rules/Skills/Religion]] (expert)
...
**Success** As critical success, except the target returns to life with 1 Hit Point and no spells prepared or points in any pools, and still is affected by any long-term debilitations of the old body. Instead of inspiring them, the character's time in the Boneyard has left them temporarily debilitated. The target is [[Rules/Conditions/Clumsy (Player Core)|clumsy 1]], [[Rules/Conditions/Drained (Player Core)|drained 1]], and [[Rules/Conditions/Enfeebled (Player Core)|enfeebled 1]] for 1 week; these conditions can't be removed or reduced by any means until the week has passed.  
...
Source on Archives of Nethys: [Resurrect](https://2e.aonprd.com/Rituals.aspx?ID=123)
