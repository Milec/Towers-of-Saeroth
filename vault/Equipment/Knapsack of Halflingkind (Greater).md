...
type: "equipment"
aon_id: "equipment-446-545"
aon_url: "https://2e.aonprd.com/Equipment.aspx?ID=446"
tags:
  - pf2e/equipment
  - rarity/uncommon
  - trait/conjuration
...
**Traits** [[Traits/Uncommon]], [[Traits/Conjuration]], [[Traits/Extradimensional]], [[Traits/Healing]], [[Traits/Invested]], [[Traits/Magical]]

**Source** [[Sources/Core Rulebook]] pg. 612
...
This sturdy leather satchel contains three compartments fastened with large clasps. The first compartment is lined in blue satin and contains an extradimensional space equivalent to a [[Equipment/Bag of Holding|_type II bag of holding_]].
...
## Knapsack of Halflingkind (Greater)  *Item 13*
...
The berry tarts each restore 4d8+8 Hit Points, and the bag has two additional compartments, each of which can be Activated with an Interact action.
 ...
 The bag’s fifth compartment is lined in black wool. Once per day, you can unfold this compartment into a 5-foot-diameter portal on the ground. The first person to Step into the portal from an adjacent square is teleported away. This has the same effect as an 5th-level [[Spells/Dimension Door|_dimension door_]] spell, except the affected creature takes the knapsack with them. When the portal is used, or at the start of your next turn if it hasn’t been used, the compartment closes automatically and can’t be unfolded until the next day.

---

Source on Archives of Nethys: [Knapsack of Halflingkind (Greater)](https://2e.aonprd.com/Equipment.aspx?ID=446)
