 ...
 **Detecting Counterfeits:** Determining something is counterfeit requires inspecting the item and succeeding at a relevant skill check against the counterfeit's DC. Typically, this is [[Rules/Skills/Crafting (Player Core)|Crafting]], but one might use [[Rules/Skills/Religion (Player Core)|Religion]] to detect a fake reliquary or [[Rules/Skills/Medicine (Player Core)|Medicine]] to realize a potion is mere snake oil. Low-grade counterfeits typically have a [[Rules/Adjusting Difficulty (GM Core)|very easy]] [[Rules/Level-Based DCs (GM Core)|DC of the item's level]], medium-grade counterfeits typically have a standard DC of the item's level, and high-grade counterfeits typically have a hard DC of the item's level.
...
Source on Archives of Nethys: [Counterfeit Item (Medium-Grade)](https://2e.aonprd.com/Equipment.aspx?ID=4131)
