...
**Source** [[Sources/Guns & Gears (Remastered)]] pg. 71
...
A material essence disruptor emits bursts of disordered energy to break down the structure of a spell that manipulates material essence. Attempt to [[Rules/Counteracting (Core Rulebook)|counteract]] an active [[Traits/Arcane|arcane]] or [[Traits/Primal|primal]] spell within the listed range, with the listed counteract modifier and counteract level.
...
Source on Archives of Nethys: [Material Essence Disruptor](https://2e.aonprd.com/Equipment.aspx?ID=1118)
