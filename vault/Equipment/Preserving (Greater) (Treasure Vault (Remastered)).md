...
**Activate** two actions ([[Traits/Concentrate (Player Core)|concentrate]], [[Traits/Manipulate (Player Core)|manipulate]]) **Frequency** once per day;   **Effect** The container casts [[Spells/Cleanse Cuisine|_cleanse cuisine_]] on all the food and drink within.

---

Source on Archives of Nethys: [Preserving (Greater)](https://2e.aonprd.com/Equipment.aspx?ID=2302)
