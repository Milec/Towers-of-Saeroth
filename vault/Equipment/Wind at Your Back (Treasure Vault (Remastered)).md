...
**Source** [[Sources/Treasure Vault (Remastered)]] pg. 117
...
**Activate** single action ([[Traits/Manipulate (Player Core)|manipulate]]) **Frequency** once per day;   **Effect** You blow across the surface of the cloud, and it floats free of you and calls up a strong breeze. For the next 8 hours, it floats behind you and your companions, increasing the amount of time the group can [[Actions/Hustle]] during exploration to the lowest Constitution modifier in the group × 20 instead of × 10. You must all remain within 100 feet to get the benefit.
...
Source on Archives of Nethys: [Wind at Your Back](https://2e.aonprd.com/Equipment.aspx?ID=2201)
