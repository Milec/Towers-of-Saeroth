...
passengers: 5
pfs: "Restricted"
piloting_check: "Driving Lore (DC 26) or Crafting (DC 28)"
price: 210000
...
**Source** [[Sources/Guns & Gears (Remastered)]] pg. 96

**Price** 2,100 gp

---

A clockwork borer is essentially a huge [[Equipment/Adamantine|adamantine]] drill attached to a large wheeled carriage. The clockwork gears within move the borer itself and spin the drill, allowing it to burrow through loose material quickly and even through solid stone at a slower rate.
...
**Piloting Check** [[Rules/Sidebars/Common Lore Subcategories|Driving Lore]] (DC 26) or [[Rules/Sidebars/Crafting Example|Crafting]] (DC 28)
...
Source on Archives of Nethys: [Clockwork Borer](https://2e.aonprd.com/Vehicles.aspx?ID=30)
