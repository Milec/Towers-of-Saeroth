...
**Traits** [[Traits/Uncommon (Player Core)|Uncommon]], [[Traits/Consumable (Player Core)|Consumable]], [[Traits/Magical (Player Core)|Magical]], [[Traits/Polymorph (Player Core)|Polymorph]], [[Traits/Potion (Player Core)|Potion]]
...
The effects of this potion use the same rules as the [[Actions/Impersonate (Player Core)|Impersonate]] activity of Deception. Onlookers always assume you're the chosen type of creature unless they're actively Seeking. You gain a +4 status bonus to your Deception DC against such Perception checks and add your level even if untrained.

## Potion of Disguise (Lesser)  *Item 5*

**Source** [[Sources/Player Core 2]] pg. 304, [[Sources/Advanced Player's Guide]] pg. 258
...
## Potion of Disguise (Moderate)  *Item 8*
...
## Potion of Disguise (Greater)  *Item 11*
...
Source on Archives of Nethys: [Potion of Disguise (Moderate)](https://2e.aonprd.com/Equipment.aspx?ID=3402)
