...
**Activate—Fill the Shell** single action ([[Traits/Manipulate|manipulate]])    **Effect** You place the shell on a level surface and sprinkle a few drops of water into its basin. The shell slowly fills with saltwater over the course of 1 minute. The shell's magic then becomes active, indicated by a steady stream of bubbles. Moving the shell disturbs its contents, causing the item to deactivate and the water inside to evaporate; otherwise, it remains activated for an unlimited duration.
...
## Shell of Easy Breathing (Greater)  *Item 9*
...
Source on Archives of Nethys: [Shell of Easy Breathing (Greater)](https://2e.aonprd.com/Equipment.aspx?ID=2632)
