---
title: "Implosion Dust"
type: "equipment"
aon_id: "equipment-4475"
aon_url: "https://2e.aonprd.com/Equipment.aspx?ID=4475"
tags:
  - pf2e/equipment
  - rarity/common
  - trait/alchemical
...
Sealed in a packet so it can be released in a pressurized puff, implosion dust causes amorphous creatures to compress and shrink by hardening and even evaporating the liquid components of their physical forms. It’s effective at weakening [[Bestiary/Families/Elemental, Water (Monster Core)|water elementals]], [[Bestiary/Families/Elemental, Air (Monster Core)|air elementals]], [[Bestiary/Families/Ooze (Monster Core)|oozes]], and other creatures the GM determines are similarly amorphous, which can even include particularly gelatinous [[Traits/Aberration (Player Core)|aberrations]]. You release the dust toward one creature within 5 feet of you, which must attempt a Fortitude saving throw. The target must repeat the saving throw at the end of each of its turns. Implosion dust functions for up to 6 rounds. It then becomes inert, and the creature returns to its normal size.
...
## Implosion Dust (Moderate)  *Item 12*
...
## Implosion Dust (Greater)  *Item 18*
...
Source on Archives of Nethys: [Implosion Dust](https://2e.aonprd.com/Equipment.aspx?ID=4475)
