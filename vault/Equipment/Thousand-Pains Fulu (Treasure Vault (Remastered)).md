...
**Traits** [[Traits/Uncommon]], [[Traits/Consumable]], [[Traits/Fulu]], [[Traits/Magical]]

**Source** [[Sources/Treasure Vault (Remastered)]] pg. 79

**Usage** affixed to a creature

---

Created by a chirurgeon who threw away morality in search of endless life, a thousand-pains fulu blocks the natural flow of elements in the body. A creature to which the fulu is affixed must attempt a [[Rules/Basic Saving Throws (Core Rulebook)|basic]] Fortitude save against damage determined by the fulu's type. Failure or critical failure primes the target for [[Rules/Sidebars/Persistent Damage Rules|persistent damage]] triggered by a specific condition that must be met within the fulu's duration.
...
This red fulu feels rigid, its edges sharp, and looking at it makes you feel feverish. The DC is 23, and the fulu deals 5d6 slashing damage as meridians burst and cut through flesh. On a failure or critical failure, if the target fails to take an action with the [[Traits/Manipulate|manipulate]] or [[Traits/Move|move]] trait on each of its turns, it takes 1d6 persistent slashing damage.
...
Looking at this black fulu leaves you queasy and cold. The DC is 30, and the fulu deals 10d6 cold damage as the target's qi warps and drains. On a failure or critical failure, if the target takes damage from a [[Traits/Poison|poison]] or [[Traits/Disease|disease]] effect or becomes sickened, it takes 2d6 persistent cold damage. These effects have the [[Traits/Cold|cold]] trait.
...
Source on Archives of Nethys: [Thousand-Pains Fulu](https://2e.aonprd.com/Equipment.aspx?ID=2044)
