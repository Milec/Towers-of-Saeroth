---
title: "Fulcrum Lenses"
type: "equipment"
aon_id: "equipment-942"
aon_url: "https://2e.aonprd.com/Equipment.aspx?ID=942"
tags:
  - pf2e/equipment
  - rarity/common
bulk: 0
...
item_category: "Other"
level: 9
primary_source: "Pathfinder #165: Eyes of Empty Death"
...
# Fulcrum Lenses  *Item 9+*

**Source** [[Sources/Pathfinder -165- Eyes of Empty Death|Pathfinder #165: Eyes of Empty Death]] pg. 75

---

_Fulcrum lenses_ are unique magical crystals that each contain a sliver of [[Setting/Deities/Nhimbaloth|Nhimbaloth's]] essence. They belong to a larger set of lenses created to manipulate or even bind the Empty Death; most of the other lenses are long lost and likely destroyed. The Haruvex family came into possession of four of the lenses, and they knew that bringing them together focused Nhimbaloth's attention in unprecedented and dangerous ways. Belcorra brought all four lenses to the Abomination Vaults with her, intending to install them in Gauntlight for her ultimate revenge upon Absalom. She also created a special receptacle called the [[Equipment/Fulcrum Lattice|_Fulcrum Lattice_]] to hold the lenses so that their power could be focused together. She realized the danger of keeping the _fulcrum lenses_ too close together until the right time and spread them out among loyal groups in the Abomination Vaults' lowest levels for safekeeping.
...
**Traits** [[Traits/Unique]], [[Traits/Enchantment]], [[Traits/Invested]], [[Traits/Occult]]
...
This concave lens has a drifting crimson cloud resembling slowly swirling blood within it. While you have the _Crimson Fulcrum Lens_ invested, you seethe with malevolent fury you can barely contain. You gain a +2 item bonus to saving throws against [[Traits/Fear|fear]] effects and a +2 item bonus to your melee [[Actions/Strike]] damage (this increases to a +4 item bonus to damage if the melee Strike is a jaws attack). You can also activate the lens in the following ways.
...
**Traits** [[Traits/Unique]], [[Traits/Invested]], [[Traits/Necromancy]], [[Traits/Occult]]
...
**Traits** [[Traits/Unique]], [[Traits/Invested]], [[Traits/Necromancy]], [[Traits/Negative]], [[Traits/Occult]]
...
This concave green lens is pitted and flawed; its jagged edges can cut those who don't handle it with care. While you have the _Emerald Fulcrum Lens_ invested, your flesh appears waxen and pallid. You gain [[Bestiary/Abilities/Negative Healing|negative healing]] and [[Spells/Harm|_harm_]] spells gain a +4 status bonus to the Hit Points they restore to you. You can also activate the lens in the following ways.

 **Activate** two actions Interact ([[Traits/Healing|healing]]); **Frequency** once per day; **Effect** You grasp the _Emerald Fulcrum Lens_ in one hand, regain 30 Hit Points, and gain a +2 item bonus to saving throws against magic for 1 round.
...
This brownish-orange lens always seems dusty and gritty, even when wet. While you have the _Ochre Fulcrum Lens_ invested, lassitude grips you. You gain resistance 10 to [[Traits/Mental|mental]] damage and a +2 status bonus to saves against [[Traits/Emotion|emotion]] effects. You can also activate the lens in the following ways.

 **Activate** two actions Interact; **Frequency** once per day; **Effect** You hold up the _Ochre Fulcrum Lens_ in your hand and the item casts [[Spells/Crushing Despair|_crushing despair_]] (DC 31 Will save).
...
Source on Archives of Nethys: [Fulcrum Lenses](https://2e.aonprd.com/Equipment.aspx?ID=942)
