---
title: "Heartening Missive"
type: "equipment"
aon_id: "equipment-4596"
aon_url: "https://2e.aonprd.com/Equipment.aspx?ID=4596"
tags:
  - pf2e/equipment
  - rarity/common
  - trait/abjuration
...
**Traits** [[Traits/Abjuration]], [[Traits/Consumable]], [[Traits/Magical]], [[Traits/Missive (Treasure Vault (Remastered))|Missive]]

**Source** [[Sources/Treasure Vault]] pg. 85
...
## Heartening Missive (Bull)  *Item 6*
...
Folded into a delicate butterfly, this missive grants the recipient a sense of grace and poise. Once during the next 24 hours, when the recipient fails a [[Rules/Skills/Diplomacy (Player Core)|Diplomacy]] or [[Rules/Skills/Performance (Player Core)|Performance]] check, they can improve the result from a failure to a success or from a critical failure to a failure. This is a [[Traits/Fortune (Player Core)|fortune]] effect.

## Heartening Missive (Rabbit)  *Item 6*
...
## Heartening Missive (Turtle)  *Item 6*
...
Source on Archives of Nethys: [Heartening Missive](https://2e.aonprd.com/Equipment.aspx?ID=4596)
