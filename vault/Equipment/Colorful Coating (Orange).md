...
type: "equipment"
aon_id: "equipment-4471-4010"
aon_url: "https://2e.aonprd.com/Equipment.aspx?ID=4471"
tags:
  - pf2e/equipment
  - rarity/common
  - trait/alchemical
...
**Source** [[Sources/Treasure Vault]] pg. 52
...
**Source** [[Sources/Treasure Vault]] pg. 53
...
Green colorful coating dries into a low-friction surface. It makes the square slippery, making it both [[Rules/Difficult Terrain (Player Core)|difficult terrain]] and [[Rules/Uneven Ground (Player Core)|uneven ground]] with a DC to [[Actions/Balance (Player Core)|Balance]] of 20. A creature that [[Actions/Step (Player Core)|Steps]] or [[Actions/Crawl (Player Core)|Crawls]] doesn’t have to attempt to Balance.

The coating also makes a coated wall or ceiling harder to climb. It imposes a +2 circumstance penalty to checks to [[Actions/Climb (Player Core)|Climb]] the coated surface.
...
Orange colorful coating contains a mixture of acidic substances. As it dries, caustic ingredients rise to the coating’s surface. The square becomes [[Rules/Hazardous Terrain (Player Core)|hazardous terrain]], dealing 1d4 acid damage to any creature that moves through it. A creature can take this acid damage only once per round.
...
Violet colorful coating contains compounds that become goopy and sticky. A square of this coating is [[Rules/Difficult Terrain (Player Core)|difficult terrain]]. Any creature that enters the square must succeed at a DC 20 Reflex save or take a –15-foot penalty to its Speeds until the end of its next turn. On a critical failure, the creature is [[Rules/Conditions/Immobilized (Player Core)|immobilized]] in the square until the end of its next turn. The target can end these effects by [[Actions/Escape (Player Core)|Escaping]] (DC 20) or spending 2 [[Actions/Interact (Player Core)|Interact]] actions to remove the sticky substances. These Interact actions don’t have to be consecutive, and other creatures can help by providing the actions.
...
Yellow colorful coating contains a variety of compounds that fill small gaps and harden into a flat surface that increases friction, making it much easier to move on the square’s surface. On the affected surface, the coating reduces [[Rules/Difficult Terrain (Player Core)|difficult terrain]] caused by slipperiness, such as from [[Rules/Ice (GM Core)|ice]] or grease; this eliminates difficult terrain, reduces greater difficult terrain to difficult terrain, and reduces uneven ground to greater difficult terrain. The coating can’t affect difficult terrain caused by features or effects not part of the surface, such as crowds, underbrush, wind, magic, and so on. The GM determines if yellow colorful coating can affect a surface’s terrain.

The coating also makes a coated wall or ceiling easier to climb. It provides a +2 circumstance bonus to checks to [[Actions/Climb (Player Core)|Climb]] the coated surface.

---

Source on Archives of Nethys: [Colorful Coating (Orange)](https://2e.aonprd.com/Equipment.aspx?ID=4471)
