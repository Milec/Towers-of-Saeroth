...
**Traits** [[Traits/General]]

**Source** [[Sources/Player Core]] pg. 259

---

You have a pet-a Tiny animal of a type you choose, such as a cat, bird, or rodent. It has the minion trait, meaning it gains 2 actions during your turn if you use the [[Actions/Command an Animal (Player Core)|Command an Animal]] action to command it; this replaces the usual effects of Command an Animal, and you don't need to attempt a Nature check. A pet can't take [[Traits/Attack (Player Core)|attack]] actions except to [[Actions/Escape (Player Core)|Escape]] or [[Actions/Force Open (Player Core)|Force Open]].
...
[[Feats/Ferocious Beasts (Player Core)|Ferocious Beasts]], [GGGHhhjjjJJK](https://2e.aonprd.com/Feats.aspx?ID=8804)

---

Source on Archives of Nethys: [Pet](https://2e.aonprd.com/Feats.aspx?ID=5186)
