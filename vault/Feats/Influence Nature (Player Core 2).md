...
**Traits** [[Traits/Downtime (Player Core)|Downtime]], [[Traits/General (Player Core)|General]], [[Traits/Skill (Player Core)|Skill]]

**Source** [[Sources/Player Core 2]] pg. 232

**Prerequisites**
Master in [[Rules/Skills/Nature (Player Core)|Nature]]
...
Source on Archives of Nethys: [Influence Nature](https://2e.aonprd.com/Feats.aspx?ID=6488)
