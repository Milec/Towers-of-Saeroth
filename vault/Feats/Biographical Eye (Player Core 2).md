...
**Traits** [[Traits/General (Player Core)|General]], [[Traits/Secret (Player Core)|Secret]], [[Traits/Skill (Player Core)|Skill]]

**Source** [[Sources/Player Core 2]] pg. 227

**Prerequisites**
Master in [[Rules/Skills/Society (Player Core)|Society]]
...
Source on Archives of Nethys: [Biographical Eye](https://2e.aonprd.com/Feats.aspx?ID=6465)
