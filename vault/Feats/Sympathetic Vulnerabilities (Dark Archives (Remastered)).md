...
level: 6
pfs: "Standard"
prerequisite: "Exploit Vulnerability mortal weakness or personal antithesis"
...
**Traits** [[Traits/Thaumaturge (Dark Archives (Remastered))|Thaumaturge]]

**Source** [[Sources/Dark Archives (Remastered)]] pg. 45

**Prerequisites**
[[Actions/Exploit Vulnerability (Dark Archives (Remastered))|Exploit Vulnerability]] mortal weakness or personal antithesis
...
When you apply your will to invoke a vulnerability, the result is more powerful, and the vulnerability ripples out in a web from your main target to affect a broader range of creatures. This has one of two effects, based on the type of vulnerability you invoked.
 ...
 While you have personal antithesis applied to a non-[[Traits/Humanoid (Player Core)|humanoid]] creature, you can apply your custom weakness to all creatures of the exact same kind. For example, if you used personal antithesis against an [[Bestiary/Ort|ort]], the custom weakness would apply to other orts but not to other types of [[Bestiary/Families/Devil (Monster Core)|devils]].

---

Source on Archives of Nethys: [Sympathetic Vulnerabilities](https://2e.aonprd.com/Feats.aspx?ID=8369)
