...
level: 6
pfs: "Standard"
prerequisite: "Vehicle Mechanic Dedication"
...
**Source** [[Sources/Guns & Gears (Remastered)]] pg. 57

**Archetype** [[Rules/Sidebars/Unions (Guns & Gears (Remastered))|Vehicle Mechanic]]
 ...
 **Clockwork** More resilient gears allow the vehicle to remain functional, even when damaged. If your signature vehicle is [[Rules/Conditions/Broken|broken]], it does not need to make the flat check to avoid losing operating time.
 ...
 **Steam** The outlet of steam forms a cloud around the vehicle as it moves. For the duration of its movement, your signature vehicle is [[Rules/Conditions/Concealed|concealed]].
...
Source on Archives of Nethys: [Superior Propulsion](https://2e.aonprd.com/Feats.aspx?ID=3150)
