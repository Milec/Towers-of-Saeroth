...
title: "Waste Walker"
type: "background"
aon_id: "background-279"
aon_url: "https://2e.aonprd.com/Backgrounds.aspx?ID=279"
tags:
  - pf2e/background
  - rarity/common
attribute:
...
skill:
  - "Survival"
  - "Mana Wastes Lore (or another similar Lore skill associated with the wastes where you grew up)."
source:
...
**Source** [[Sources/Guns & Gears (Remastered)]] pg. 123
...
You're trained in the [[Rules/Skills/Survival]] skill, and the [Mana Wastes Lore](https://2e.aonprd.com/skills/lore) skill (or another similar Lore skill associated with the wastes where you grew up). You gain the [[Feats/Forager]] skill feat.

---

Source on Archives of Nethys: [Waste Walker](https://2e.aonprd.com/Backgrounds.aspx?ID=279)
