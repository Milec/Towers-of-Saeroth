...
aon_url: "https://2e.aonprd.com/Backgrounds.aspx?ID=267"
tags:
  - pf2e/background
  - rarity/common
attribute:
...
You're trained in the [[Rules/Skills/Medicine]] skill, and the [Underworld Lore](https://2e.aonprd.com/skills/lore) skill. You gain the [[Feats/Risky Surgery]] skill feat.

---

Source on Archives of Nethys: [Back-Alley Doctor](https://2e.aonprd.com/Backgrounds.aspx?ID=267)
