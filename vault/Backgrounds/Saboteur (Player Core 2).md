...
aon_url: "https://2e.aonprd.com/Backgrounds.aspx?ID=457"
tags:
  - pf2e/background
  - rarity/common
attribute:
...
**Source** [[Sources/Player Core 2]] pg. 51, [[Sources/Guns & Gears (Remastered)]] pg. 45
...
You're trained in the [[Rules/Skills/Thievery (Player Core)|Thievery]] skill, and the [Engineering Lore](https://2e.aonprd.com/skills/lore) skill. You gain the [[Feats/Concealing Legerdemain]] skill feat.

---

Source on Archives of Nethys: [Saboteur](https://2e.aonprd.com/Backgrounds.aspx?ID=457)
