...
type: "background"
aon_id: "background-274"
aon_url: "https://2e.aonprd.com/Backgrounds.aspx?ID=274"
tags:
  - pf2e/background
  - rarity/common
attribute:
...
skill:
  - "Crafting"
  - "Engineering Lore or Mining Lore skill."
source:
...
You're trained in the [[Rules/Sidebars/Crafting Example|Crafting]] skill, and the [Engineering Lore](https://2e.aonprd.com/skills/lore) skill or Mining Lore skill. You gain the [[Feats/Crafter's Appraisal]] skill feat.

---

Source on Archives of Nethys: [Junk Collector](https://2e.aonprd.com/Backgrounds.aspx?ID=274)
