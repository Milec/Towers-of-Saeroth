...
title: "Barrister"
type: "background"
aon_id: "background-413"
aon_url: "https://2e.aonprd.com/Backgrounds.aspx?ID=413"
tags:
  - pf2e/background
  - rarity/common
attribute:
...
**Source** [[Sources/Player Core]] pg. 85
...
You're trained in the [[Rules/Sidebars/Changing Attitudes|Diplomacy]] skill, and the [Legal Lore](https://2e.aonprd.com/skills/lore) skill. You gain the [[Feats/Group Impression]] skill feat.

---

Source on Archives of Nethys: [Barrister](https://2e.aonprd.com/Backgrounds.aspx?ID=413)
