...
type: "deity"
aon_id: "deity-17"
aon_url: "https://2e.aonprd.com/Deities.aspx?ID=17"
tags:
  - pf2e/deity
  - rarity/common
  - trait/ng
...
domain_primary:
  ...
  - "Passion"
  - "Protection"
edict: "be peaceful, choose and perfect an art, lead by example, see the beauty in all things"
epithet: "The Eternal Rose"
favored_weapon:
  - "Glaive"
follower_alignment:
  - "LG"
...
# Shelyn (The Eternal Rose)  *Deity*

**Traits** [[Rules/Alignment (Core Rulebook)|NG]]
...
**Pantheons**
[[Setting/Deities/The Enlightened Scholar's Path]], [[Setting/Deities/The Prismatic Ray]], [[Setting/Deities/The Resplendent Court]]
...
**Divine Skill** [[Rules/Sidebars/Crafting Example|Crafting]]

**Favored Weapon** [[Equipment/Weapons/Glaive]]

**Domains** [[Magic/Domains/Creation]], [[Magic/Domains/Family]], [[Magic/Domains/Passion]], [[Magic/Domains/Protection]]

**[[Rules/Alternate Domains]]** [[Magic/Domains/Repose]]
...
**Source** [[Sources/Gods & Magic]] pg. 45

**Minor Boon** Once, when you roll a failure on a [[Rules/Sidebars/Changing Attitudes|Diplomacy]] check, you get a critical success instead. Shelyn typically grants this boon only when the Diplomacy check would serve to increase love or offer a chance of redemption.

**Moderate Boon** You are inspired to create great works and become a virtuoso at all arts. You gain the [[Feats/Specialty Crafting]] feat and the [[Feats/Virtuosic Performer|Virtuoso Performer]] feat in all categories of Crafting and Performance.

**Major Boon** Your inner beauty and love surround you in an aura. As long as you bear them no ill will, all creatures other than fiends, undead, and mindless creatures start with an attitude of [[Rules/Conditions/Friendly|friendly]] toward you, unless they would have been [[Rules/Conditions/Helpful|helpful]] instead. This doesn’t mean they are willing to change their life or plans for you, and this boon does not prevent their attitudes from worsening if you try to thwart them. This effect doesn’t work against deities and similarly powerful creatures. Additionally, the love you share with your friends inspires them. You and your allies gain a +3 status bonus to saving throws and skill checks as long as you can see each other.

**Minor Curse** You heart churns with remorse. Each day, you are [[Rules/Conditions/Sickened|sickened 1]] as a specific misdeed plays out in your mind over and over in guilt. You can’t remove this condition, though it abates enough for you to quickly eat and drink when necessary. If you make amends or otherwise earnestly pursue redemption for the misdeed, the sickened condition fades completely that day.
...
Source on Archives of Nethys: [Shelyn](https://2e.aonprd.com/Deities.aspx?ID=17)
