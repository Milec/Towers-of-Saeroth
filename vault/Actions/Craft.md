...
type: "action"
aon_id: "action-43"
aon_url: "https://2e.aonprd.com/Actions.aspx?ID=43"
tags:
  - pf2e/action
  - rarity/common
  - trait/downtime
...
**Traits** [[Traits/Downtime]], [[Traits/Manipulate]]

**Source** [[Sources/Core Rulebook]] pg. 244

---

You can make an item from raw materials. You need the [[Feats/Alchemical Crafting]] skill feat to create alchemical items, the [[Feats/Magical Crafting]] skill feat to create magic items, and the [[Feats/Snare Crafting]] feat to create snares.
...
- You have an appropriate set of tools and, in many cases, a workshop. For example, you need access to a smithy to forge a metal shield, or an [[Equipment/Alchemist's Lab|alchemist's lab]] to produce [[Rules/Category Pages/Adventuring Gear|alchemical items]].
...
Source on Archives of Nethys: [Craft](https://2e.aonprd.com/Actions.aspx?ID=43)
