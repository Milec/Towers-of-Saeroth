...
type: "action"
aon_id: "action-2406"
aon_url: "https://2e.aonprd.com/Actions.aspx?ID=2406"
tags:
  - pf2e/action
  - rarity/common
  - trait/exploration
...
**Traits** [[Traits/Exploration (Player Core)|Exploration]], [[Traits/Secret]]

**Source** [[Sources/Player Core]] pg. 246

---

Using the stars, the position of the sun, traits of the geography or flora, or the behavior of fauna, you can stay oriented in the wild. Typically, you attempt a [[Rules/Skills/Survival]] check only once per day, but some environments or changes might necessitate rolling more often. The GM determines the DC and how long this activity takes (usually just a minute or so). More unusual locales or those you're unfamiliar with might require you to have a minimum proficiency rank to Sense Direction. Without a [[Equipment/Compass|compass]], you take a –2 item penalty to checks to Sense Direction.
...
Source on Archives of Nethys: [Sense Direction](https://2e.aonprd.com/Actions.aspx?ID=2406)
