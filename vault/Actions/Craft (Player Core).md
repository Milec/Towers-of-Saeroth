...
type: "action"
aon_id: "action-2385"
aon_url: "https://2e.aonprd.com/Actions.aspx?ID=2385"
tags:
  - pf2e/action
  - rarity/common
  - trait/downtime
...
**Traits** [[Traits/Downtime (Player Core)|Downtime]], [[Traits/Manipulate]]

**Source** [[Sources/Player Core]] pg. 237

---

You can make an item from raw materials. You need the [[Feats/Alchemical Crafting]] skill feat to create alchemical items and the [[Feats/Magical Crafting]] skill feat to create magic items.
...
- The item must be [[Setting/Languages/Common|common]], or you must otherwise have access to it.
...
Source on Archives of Nethys: [Craft](https://2e.aonprd.com/Actions.aspx?ID=2385)
