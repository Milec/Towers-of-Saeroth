...
type: "action"
aon_id: "action-72"
aon_url: "https://2e.aonprd.com/Actions.aspx?ID=72"
tags:
  - pf2e/action
  - rarity/common
...
**Source** [[Sources/Core Rulebook]] pg. 302
...
- Material ([[Traits/Manipulate|manipulate]])
- Somatic (manipulate)
- Verbal ([[Traits/Concentrate|concentrate]])
- Focus (manipulate)

 **Disrupted and Lost Spells** Some abilities and spells can disrupt a spell, causing it to have no effect and be lost. When you lose a spell, you've already expended the spell slot, spent the spell's costs and actions, and used the Cast a Spell activity. If a spell is disrupted during a Sustain a Spell action, the spell immediately ends. The full rules for disrupting actions appear [[Rules/Disrupting Actions|here]].

---

Source on Archives of Nethys: [Cast a Spell](https://2e.aonprd.com/Actions.aspx?ID=72)
