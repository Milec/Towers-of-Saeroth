...
type: "action"
aon_id: "action-2364"
aon_url: "https://2e.aonprd.com/Actions.aspx?ID=2364"
tags:
  - pf2e/action
  - rarity/common
  - trait/downtime
...
You use one of your skills to make money during downtime. The GM assigns a task level representing the most lucrative job available. You can search for lower-level tasks, with the GM determining whether you find any. Sometimes you can attempt to find better work than the initial offerings, though this takes time and requires using the [[Rules/Sidebars/Changing Attitudes|Diplomacy]] skill to [[Actions/Gather Information]], doing some research, or socializing.
...
Source on Archives of Nethys: [Earn Income](https://2e.aonprd.com/Actions.aspx?ID=2364)
