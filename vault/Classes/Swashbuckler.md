...
type: "class"
aon_id: "class-15"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=15"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
**Source** [[Sources/Advanced Player's Guide]] pg. 82
...
>
> **[[Traits/Finisher]]**: Finishers are spectacular finishing moves that use your panache. You can use a finisher only if you have panache, and you lose your panache immediately after performing a finisher. Once you use a finisher, you can't use actions that have the [[Traits/Attack|attack]] trait for the rest of your turn. Some actions with the finisher trait also grant an effect on a failure. Effects added on a failure don't apply on a critical failure. If your finisher action succeeds, you can still choose to apply the failure effect instead. For example, you might do this when an attack deals no damage due to resistance.
>
> [[Traits/Flourish|**Flourish**]]: Actions with this trait are special techniques that require too much exertion for you to perform frequently. You can use only 1 action with the flourish trait per turn.
>
...
Trained in [[Rules/Skills/Acrobatics]]  
 Trained in one skill determined by your swashbuckler's style  
 Trained in a number of additional skills equal to 4 plus your Intelligence modifier
...
At 3rd level, 7th level, and 15th level, you gain a skill feat. This feat must be for [[Rules/Skills/Acrobatics]] or the trained skill from your swashbuckler's style.
...
As a swashbuckler at the peak of your skill, you swell with confidence and bravado in every attack. Your proficiency rank for your swashbuckler class DC increases to master.
 ...
 When you Strike as part of a finisher or Opportune Riposte, you can give the Strike the failure effect from the Confident Finisher action, including the increase from [[Feats/Precise Finisher]] if you have that feat. You can do so only if the Strike uses a weapon or unarmed attack that you could use for Confident Finisher.
...
Source on Archives of Nethys: [Swashbuckler](https://2e.aonprd.com/Classes.aspx?ID=15)
