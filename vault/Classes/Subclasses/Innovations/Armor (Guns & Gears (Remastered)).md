...
type: "innovation"
aon_id: "innovation-1"
aon_url: "https://2e.aonprd.com/Innovations.aspx?ID=1"
tags:
  - pf2e/innovation
  - rarity/common
...
**Source** [[Sources/Guns & Gears (Remastered)]] pg. 16
...
- **Harmonic Oscillator** You designed your armor to inaudibly thrum at just the right frequency to create interference against force and sound waves. You gain resistance equal to 3 + half your level to [[Traits/Force|force]] and [[Traits/Sonic|sonic]] damage. When under the effects of Overdrive, the resistance increases by 2.
- **Metallic Reactance** The metals in your armor are carefully alloyed to ground electricity and protect from acidic chemical reactions. You gain resistance equal to 3 + half your level to [[Traits/Acid|acid]] and [[Traits/Electricity|electricity]] damage. When under the effects of Overdrive, the resistance increases by 2.
- **Muscular Exoskeleton (Power Suit Only)** Your armor supports your muscles with a carefully crafted exoskeleton. When you send your armor into overdrive, the exoskeleton supplements your feats of athletics as well. When under the effects of Overdrive, you gain a +1 circumstance bonus to [[Rules/Sidebars/Falling|Athletics]] checks; if you're a master in [[Rules/Sidebars/Crafting Example|Crafting]], this increases to a +2 circumstance bonus.
- **Otherworldly Protection** Just because you prefer science doesn’t mean you can’t build your armor with materials and gizmos designed to protect against otherworldly attacks. You gain resistance equal to 3 + half your level to [[Traits/Void|void]] damage, or to [[Traits/Vitality|vitality]] damage if you have void healing (such as if you’re a dhampir). You gain the same amount of resistance to [[Traits/Spirit (Player Core)|spirit]] damage. If you are [[Traits/Sanctified|sanctified]] (such as by also being a champion or cleric dedicated to a deity who allows or enforces sanctification) this resistance applies to [[Traits/Unholy|unholy]] damage (if you are sanctified holy) or [[Traits/Holy|holy]] damage (if you are sanctified unholy), regardless of what other traits the damage has
- **Phlogistonic Regulator** A layer of insulation within your armor protects you from rapid temperature fluctuations. You gain resistance equal to half your level to [[Traits/Cold|cold]] and [[Traits/Fire|fire]] damage. When under the effects of Overdrive, the resistance increases by 2.
...
- **Subtle Dampeners (Subterfuge Suit Only)** You've designed your armor to help you blend in and dampen noise slightly. When you send your armor into overdrive, the dampeners increase their effect, improving your [[Rules/Sidebars/Being Stealthy|Stealth]]. When under the effects of Overdrive, you gain a +1 circumstance bonus to Stealth checks. If you're a master in [[Rules/Sidebars/Crafting Example|Crafting]], this increases to a +2 circumstance bonus.

## Breakthrough Modifications  *Level 7*

- **Antimagic Plating** Whether you used some clever adaptation of the magic-negating skymetal known as noqual or created magical protections of your own design, you've strengthened your armor against magic. While wearing the armor, you gain a +1 circumstance bonus to all saving throws against spells and to AC against spells. Against spells that target the armor directly (like [[Spells/Heat Metal|_heat metal_]]), you instead gain a +4 circumstance bonus to all saving throws and to AC.
- **Camouflage Pigmentation (Subterfuge Suit Only)** You've modified your armor's exterior to let you blend into your surroundings with ease, as long as you stay still. While wearing your armor, you can [[Actions/Hide]] even without cover or concealment, as the pigmentation shifts to match your surroundings.
...
- **Energy Barrier** Your armor's defenses ablate any kind of energy coming your way. While wearing your armor, you gain resistance to all energy damage ([[Traits/Acid (Player Core)|acid]], [[Traits/Cold (Player Core)|cold]], [[Traits/Electricity (Player Core)|electricity]], [[Traits/Fire (Player Core)|fire]], [[Traits/Force (Player Core)|force]], [[Traits/Sonic (Player Core)|sonic]], [[Traits/Vitality|vitality]], and [[Traits/Void|void]] damage) equal to 2 + half your level. You must have the harmonic oscillator, metallic reactance, or phlogistonic regulator modification to select this modification.
...
- **Multisensory Mask (Subterfuge Suit Only)** You've built a multisensory mask over your armor that protects you by distorting your figure from all senses, leaving behind only a hazy image, muffled sounds, and so forth. While wearing the armor, you gain [[Rules/Conditions/Concealed|concealment]] against all creatures, even if they are using a nonvisual [[Rules/Precise Senses|precise sense]], such as a bat's echolocation. As normal for effects that leave your location obvious, you can't use this concealment to [[Actions/Hide]] or [[Actions/Sneak]]. If you use a [[Rules/Hostile Actions|hostile action]], the concealment ends until you restore the mask as a single action, which has the [[Traits/Manipulate|manipulate]] trait.
- **Perfect Fortification (Power Suit Only)** You've outfitted your armor with such heavy fortifications that deadly attacks often lose their edge. Each time you're critically hit while wearing the armor, attempt a DC 13 flat check. On a success, it becomes a normal hit. This isn't cumulative with [[Equipment/Fortification|_fortification_]] runes or other abilities that reduce critical hits with a flat check. Additionally, you gain resistance 2 + half your level against precision damage.
