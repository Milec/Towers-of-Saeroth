...
image:
  - "/Images/Classes/Iconic_Thaleon.png"
...
>
>  **[[Traits/Amp]]**: Amps are special thoughtforms that modify the properties of your psi cantrips. You can apply an amp only to a psi cantrip, which is called the amped cantrip. Applying an amp to a psi cantrip costs 1 [[Rules/Focus]] Point and is part of the actions needed to [[Actions/Cast a Spell (Player Core)|Cast the Spell]]. The singular focus required to amp a psi cantrip means that unless otherwise noted, you can apply only one amp to a given psi cantrip, and you can’t apply both an amp and a [[Traits/Metamagic|metamagic]] ability to a cantrip at the same time. If both an amp and the amped cantrip deal damage of the same type, combine their damage for the purpose of resistances and weaknesses. Feats with the amp trait provide different amps you can apply to psi cantrips in place of their normal amps. If an amp has its own effect, its level is the same as the amped cantrip’s.
>
...
>
>  **[[Traits/Mindshift]]**: An action with this trait can always be altered to use the raw power of your mind. When you take this action, you can choose to replace any damage it deals with mental damage, give it the mental trait, and replace any save it requires with a Will save. The action loses any traits matching damage types it no longer deals.
>
>  **[[Traits/Psyche]]**: Your psyche must be unleashed to use abilities that have the psyche trait, and they end automatically when your unleashed psyche subsides.
...
Trained in [[Rules/Skills/Occultism]]  
 Trained in a number of additional skills equal to 3 plus your Intelligence modifier
...
Trained in [[Magic/Traditions/Arcane|occult]] spell attack rolls  
 Trained in [[Magic/Traditions/Arcane|occult]] spell DCs
...
| * Your conscious mind gives you three additional cantrips with amps. One cantrip is unique to your conscious mind. † The infinite mind class feature gives you a 10th-level spell slot that works a bit differently from other spell slots. |  |  |  |  |  |  |  |  |  |  |  |
...
You access the vast well of power that resides within your own mind, calling forth psychic magic with nothing but thought and will. You can cast [[Magic/Traditions/Arcane|occult]] spells using the [[Actions/Cast a Spell (Player Core)|Cast a Spell]] activity. You alter some of the standard spell components when casting spells you know from your psychic spellcasting. Instead of speaking, you substitute any verbal components with a special mental component determined by your subconscious mind class feature. This represents how you exert your mind toward your intended effect. Any of these components impart the [[Traits/Concentrate (Player Core)|concentrate]] trait to the spell you’re casting. You also substitute any material components with somatic components, though these tend to be simple movements of the hand or head compared to those used by other spellcasters. Your spells still have clear and noticeable visual and auditory manifestations, as normal for a spellcaster.
...
Conscious mind options can be found [here](ConsciousMinds.aspx)

### Psychic Feats  *Level 2*

At 2nd level and every even-numbered level, you gain a [[Rules/Category Pages/Feats|psychic class feat]].
...
Self-reflection has brought you greater knowledge of yourself and, with it, psychic power. Your proficiency ranks for [[Magic/Traditions/Arcane|occult]] spell attack rolls and spell DCs increase to expert.
...
You’ve gained access to the deepest corners of your own mind. Your proficiency ranks for [[Magic/Traditions/Arcane|occult]] spell attack rolls and spell DCs increase to master.
...
As your training reaches its peak, you understand not just your own mind, but the collective unconscious from which all psychic power stems. Your proficiency ranks for [[Magic/Traditions/Arcane|occult]] spell attack rolls and spell DCs increase to legendary.

---

Source on Archives of Nethys: [Psychic](https://2e.aonprd.com/Classes.aspx?ID=21)
