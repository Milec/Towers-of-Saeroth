...
hp: 8
icon_image: "/Images/Class/Magus_Icon.png"
image:
  - "/Images/Classes/Iconic_Seltyiel.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/magus"
  - "label Feats"
  - "url /classes/magus/feats"
  - "label Sample Builds"
  - "url /classes/magus/sample-builds"
  - "label Class Kit"
  - "url /classes/magus/class-kit"
  - "label Focus Spells"
  - "url /classes/magus/focus-spells"
  - "label Hybrid Studies"
  - "url /classes/magus/hybrid-studies"
...
**Source** [[Sources/Impossible Magic]] pg. 9
...
>
>
> Feats like [[Feats/Burning Cascade]], [[Feats/Devastating Spellstrike (Impossible Magic)|Devastating Spellstrike]], and [[Feats/Distracting Spellstrike (Impossible Magic)|Distracting Spellstrike]] have values dependent on your Arcane Cascade damage. Note that abilities that can increase the extra damage, such as the [[Classes/Subclasses/Hybrid Studies/Laughing Shadow (Impossible Magic)|laughing shadow]] and [[Classes/Subclasses/Hybrid Studies/Twofold Tine|twofold tine]] hybrid studies, apply only to the Strikes that meet their criteria, not to other abilities. This means feats like the listed ones use the base damage value, not the boosted one!
...
>
> [[Traits/Stance (Player Core)|**Stance**]]: A stance is a general combat strategy that you enter by using an action with the stance trait, and you remain in for some time. A stance lasts until you get knocked out, until its requirements (if any) are violated, until the encounter ends, or until you use a stance action again, whichever comes first. After you take an action with the stance trait, you can’t take another one for 1 round. You can enter or be in a stance only in encounter mode. You can Dismiss a stance.
...
Trained in [[Rules/Skills/Arcana (Player Core)|Arcana]]  
 Trained in a number of additional skills equal to 2 plus your Intelligence modifier
...
You study spells so you can combine them with your attacks or solve problems that strength of arms alone can't handle. You are a spellcaster, and you can cast spells of the arcane tradition using the Cast a Spell activity. As a magus, when you cast spells, you might draw sigils with your weapon or a free hand and shout magical words of power as battle cries.
 ...
 Some of your spells require you to attempt a spell attack to see how effective they are, or have your enemies roll against your spell DC (typically by attempting a saving throw). Your [[Rules/Spell Attack Rolls (Player Core)|spell attack modifier]] and [[Rules/Spell DC|spell DC]] are calculated using your Intelligence modifier.
...
### Spellbook
 ...
 Every arcane spell has a written version, which you record in your personalized book of spells. You start with a [[Equipment/Spellbook (Blank) (Player Core)|spellbook]] worth 10 sp or less, which you receive for free and must study each day to prepare your spells. Your spellbook's form and name are up to you. It might be anything from a sturdy book with a secure latch entitled _Theses on the Stratagems of Supernatural Warfare_ to a tattered collection of training pamphlets with your name scrawled on the cover.

 The spellbook contains your choice of eight arcane cantrips and five 1st-rank arcane spells. You choose these from the common spells on the [[Magic/Traditions/Arcane|arcane spell list]] or from other arcane spells you gain access to.

 Each time you gain a level, you add two arcane spells to your spellbook, of any spell rank for which you have spell slots, chosen from common spells of your tradition or others you gain access to. You can also add spells to your spellbook with the [[Actions/Learn a Spell (Player Core)|Learn a Spell]] activity.

 If you have a spellbook from multiple sources (such as being a magus with the [[Feats/Wizard Dedication (Player Core)|Wizard Dedication]] feat, you can use the same spellbook for all your spells.
 ...
 **One Target:** The spell targets only the target of your Strike, even if it normally allows more targets. This includes area spells, against which only the target attempts a saving throw. Any ongoing effects of the area, such as the [[Rules/Difficult Terrain (Player Core)|difficult terrain]] from [[Spells/Scatter Scree (Player Core 2)|_scatter scree_]], affect only the target's space. Some feats let you affect more creatures.

 **Reach:** The coupled spell affects the target using the reach of the weapon or unarmed attack you use for your Spellstrike. For instance, [[Spells/Gouging Claw (Player Core)|_gouging claw_]] would affect a creature beyond the reach of your hand if you used a weapon with reach, and [[Spells/Frostbite|_frostbite_]] would affect only a creature in your weapon's reach, even though the spell's range is longer.

 **Ancillary Effects:** Your spell still has any non-targeted effects that might affect creatures other than the target, as well as any ongoing effects starting from the moment you hit with the Strike. For example, _scatter scree_ would still create difficult terrain in the target's space (as mentioned above), and [[Spells/Tangle Vine|_tangle vine's_]] circumstance penalty would last for its normal duration. The spell takes effect after the Strike deals damage; if the Strike has other special effects, the GM determines whether they happen before or after the spell.
...
At 2nd level and every 2 levels thereafter, you gain a [[Rules/Category Pages/Feats|magus class feat]].

### Skill Feats  *Level 2*

At 2nd level and every 2 levels thereafter, you gain a [[Rules/Category Pages/Feats|skill feat]]. You must be trained or better in the corresponding skill to select a skill feat.

### General Feats  *Level 3*

At 3rd level and every 4 levels thereafter, you gain a [[Rules/Category Pages/Feats|general feat]].
...
### Studious Spell  *Level 7*

You've deeply studied certain beneficial spells to speedily enter Arcane Cascade when you cast them. When you cast a studious spell, you can use Arcane Cascade as a free action as your next action this turn. Add any studious spell you gain to your spellbook if you don't know it already. Your studious spells are [[Spells/Gecko Grip|_gecko grip_]] and an additional spell depending on your hybrid study, listed in the hybrid study's entry.

 At 11th level, add [[Spells/Haste (Player Core)|_haste_]] and an additional spell depending on your hybrid study to your studious spells.

 At 13th level, add [[Spells/Fly (Player Core)|_fly_]] and an additional spell depending on your hybrid study to your studious spells.
...
Source on Archives of Nethys: [Magus](https://2e.aonprd.com/Classes.aspx?ID=74)
