...
hp: 8
icon_image: "/Images/Class/Druid_Icon.png"
image:
  - "/Images/Classes/Iconic_Lini.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/druid"
  - "label Feats"
  - "url /classes/druid/feats"
  - "label Sample Builds"
  - "url /classes/druid/sample-builds"
  - "label Class Kit"
  - "url /classes/druid/class-kit"
  - "label Focus Spells"
  - "url /classes/druid/focus-spells"
  - "label Druidic Orders"
  - "url /classes/druid/druidic-orders"
...
**Source** [[Sources/Player Core]] pg. 122
...
The power of the wild world flows through you. You are a spellcaster and can cast spells of the primal tradition using the [[Actions/Cast a Spell]] activity (see [[Rules/Casting Spells]]). As a druid, your spellcasting incantations might be pleas to the environment around you or the invocation of ancient vows; your hands might sway like willows or curl into clawlike shapes as your gestures direct your magic.

 At 1st level, you can prepare two 1st-rank spells and five cantrips each morning from the common spells on the [[Magic/Traditions/Arcane|primal]] spell list, or from other primal spells to which you gain access and learn via [[Actions/Learn a Spell]]. Prepared spells remain available to you until you cast them or until you prepare your spells again. The number of spells you can prepare each day is called your spell slots.
...
As stewards of the natural order, druids find affronts to nature anathema. If you repeatedly perform these acts, you lose your magical abilities from the druid class, including your druid spellcasting and the benefits of your order. These abilities can be regained only if you demonstrate your repentance with an [[Rituals/Atone|_atone_]] ritual. The following acts are anathema to all druids.

 **Anathema** despoil natural places, consume more natural resources than you require to live comfortably, teach the [[Setting/Languages/Wildsong]] to non-druids.
...
Upon becoming a druid, you align yourself with a druidic order, which grants you a class feat, an order spell (see below), and an additional trained skill tied to your order. While you'll always be a member of your initial order, it's not unheard of for a druid to request to study with other orders in search of greater understanding of the natural world, and PC druids are among the most likely to blend the powers of different orders.
 ...
 Order spells are a type of focus spell. It costs 1 Focus Point to cast a focus spell, and you start with a focus pool of 1 Focus Point. You refill your focus pool during your daily preparations, and you can regain 1 Focus Point by spending 10 minutes using the [[Actions/Refocus]] activity to commune with local nature spirits or otherwise tend to the wilderness in a way befitting your order.
...
You gain your choice of the [[Feats/Animal Empathy (Druid)|Animal Empathy]] or [[Feats/Plant Empathy]] druid feat.

### Wildsong

You know the [[Setting/Languages/Wildsong]], a secret language known only within druid orders, in addition to any languages you know through your ancestry. The Wildsong is a melodic and tonal language sounding more like animal calls than a spoken tongue, and its alphabet involves fractals and spirals, like the arrangement of a seashell's chambers, a snowflake's crystals, or a fern's fronds. Teaching the Wildsong to non-druids is anathema.

### Druid Feats  *Level 2*

At 2nd level and every even-numbered level, you gain a [[Rules/Category Pages/Feats|druid class feat]].
