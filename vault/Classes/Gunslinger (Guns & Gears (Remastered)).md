...
hp: 8
icon_image: "/Images/Class/Gunslinger_Icon.png"
image:
  - "/Images/Classes/Iconic_Nhalmika.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/gunslinger"
  - "label Feats"
  - "url /classes/gunslinger/feats"
  - "label Sample Builds"
  - "url /classes/gunslinger/sample-builds"
  - "label Class Kit"
  - "url /classes/gunslinger/class-kit"
  - "label Ways"
  - "url /classes/gunslinger/ways"
...
**Source** [[Sources/Guns & Gears (Remastered)]] pg. 105

_[**PFS Note**](https://2e.aonprd.com/pathfinder-society) All Pathfinder Society agents have access to the Gunslinger class._
...
>
>  [[Traits/Flourish|**Flourish**]]: Flourish actions are actions that require too much exertion to perform a large number in a row. You can use only 1 action with the flourish trait per turn.
>
...
All gunslingers have a particular way they follow, a combination of philosophy and combat style that defines both how they fight and the weapons they excel with. At 1st level, your way grants you an initial deed, a unique reload action called a slinger's reload, and proficiency with a particular skill. You also gain advanced and greater deeds at later levels, as well as access to way-specific feats.
 ...
 Gunslinger ways can be found [here](Ways.aspx).

### Gunslinger Feats

At 1st level and every even-numbered level, you gain a [[Rules/Category Pages/Feats|gunslinger class feat]].

### Slinger's Precision

You have steady precision with guns and crossbows and can use weapons that incorporate them effectively. You deal an extra +2 precision damage with Strikes made using [[Equipment/Weapon Groups/Crossbow|crossbows]] that don't have the [[Traits/Repeating|repeating]] trait, and deal an extra 1d4 precision damage on Strikes with [[Equipment/Weapon Groups/Firearm|firearms]] that don't have the repeating trait.
 ...
 If you are using a [[Traits/Combination|combination]] weapon whose ranged form is a firearm or crossbow, you use your proficiency with firearms and crossbows for attacks made with the melee portion of that weapon.
...
You fully understand the best way to utilize your unique weapons. Your proficiency rank increases to master with simple and martial firearms and crossbows. Your proficiency rank for advanced firearms and crossbows, simple weapons, martial weapons, and unarmed attacks increases to expert. You gain access to the [[Rules/Critical Specialization Effects|critical specialization effects]] for firearms and crossbows.
