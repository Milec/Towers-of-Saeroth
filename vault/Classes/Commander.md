...
hp: 8
icon_image: "/Images/Class/Commander_Icon.png"
image:
  - "/Images/Classes/Iconic_Ulka_Oathshriek.webp"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/commander"
  - "label Feats"
  - "url /classes/commander/feats"
  - "label Sample Builds"
  - "url /classes/commander/sample-builds"
  - "label Class Kit"
  - "url /classes/commander/class-kit"
...
**Source** [[Sources/Battlecry!]] pg. 21
...
Trained in [[Rules/Skills/Society (Player Core)|Society]] and [[Rules/Sidebars/Common Lore Subcategories (Player Core)|Warfare Lore]]  
Trained in a number of additional skills equal to 2 plus your Intelligence modifier
...
At 1st level and every even-numbered level, you gain a [[Rules/Category Pages/Feats|commander class feat]].
...
### Expert Tactician  *Level 7*

Your time spent leading and training others on battlefield tactics has improved your combat acumen. Your proficiency rank for your commander class DC increases to expert, and you add two new tactics to your folio; these can be any mobility or offensive tactics you don’t already know, or you can choose from expert tactics you have access to. The total number of tactics you can have prepared increases to four. In addition, your proficiency rank in [[Rules/Sidebars/Common Lore Subcategories (Player Core)|Warfare Lore]] increases to master.
...
### Armor Expertise  *Level 11*

You have spent so much time in armor that you know how to make the most of its protection. Your proficiency ranks for light, medium, and heavy armor, as well as for unarmored defense, increase to expert. You gain the [[Rules/Armor Specialization Effects (Player Core)|armor specialization effects]] of medium and heavy armor.

### Commanding Will  *Level 11*
...
### Battlefield Intuition  *Level 15*
...
Source on Archives of Nethys: [Commander](https://2e.aonprd.com/Classes.aspx?ID=66)
