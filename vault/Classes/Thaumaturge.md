...
type: "class"
aon_id: "class-22"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=22"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
hp: 8
icon_image: "/Images/Class/Thaumaturge_Icon.png"
image:
  - "/Images/Classes/Iconic_Mios.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/thaumaturge"
  - "label Feats"
  - "url /classes/thaumaturge/feats"
  - "label Sample Builds"
  - "url /classes/thaumaturge/sample-builds"
  - "label Class Kit"
  - "url /classes/thaumaturge/class-kit"
  - "label Implements"
  - "url /classes/thaumaturge/implements"
...
**Source** [[Sources/Dark Archive]] pg. 30
...
- Mistake you for a common [[Classes/Class Features/Ancestry and Background (class-feature-282)|wizard]] or magician.
...
Trained in [[Rules/Skills/Arcana]], [[Rules/Sidebars/Commanded Animals|Nature]], [[Rules/Skills/Occultism]], and [[Rules/Skills/Religion]]  
 Trained in a number of additional skills equal to 3 plus your Intelligence modifier
...
Your experience with the unknown, as well as the tales you've exchanged with other thaumaturges, has taught you about strange phenomena of every kind. You become trained in [[Rules/Sidebars/Common Lore Subcategories|Esoteric Lore]], a special lore skill that can be used to [[Actions/Recall Knowledge]] regarding [[Traits/Haunt|haunts]], [[Traits/Curse|curses]], and creatures of any type, but that can't be used to Recall Knowledge of other topics. Unlike a normal Lore skill, you use Charisma as your modifier on Esoteric Lore checks. You also gain the [[Feats/Dubious Knowledge]] skill feat.
...
At 1st level and every even-numbered level, you gain a [[Rules/Category Pages/Feats|thaumaturge class feat]].
...
You've learned the secret ways your weapons work most effectively. Your proficiency ranks for [[Traits/Unarmed|unarmed]] attacks, simple weapons, and martial weapons increase to expert.
...
You also gain an additional skill increase, which you can apply only to [[Rules/Skills/Arcana]], [[Rules/Sidebars/Commanded Animals|Nature]], [[Rules/Skills/Occultism]], or [[Rules/Skills/Religion]].
...
You fully understand your weapons. Your proficiency ranks for [[Traits/Unarmed|unarmed]] attacks, simple weapons, and martial weapons increase to master.
...
Source on Archives of Nethys: [Thaumaturge](https://2e.aonprd.com/Classes.aspx?ID=22)
