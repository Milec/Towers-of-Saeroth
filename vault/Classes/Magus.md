...
type: "class"
aon_id: "class-17"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=17"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
**Source** [[Sources/Secrets of Magic]] pg. 35
...
>
>  **[[Traits/Stance]]**: A stance is a general combat strategy that you enter by using an action with the stance trait, and you remain in that stance for some time. A stance lasts until you get knocked out, until its requirements (if any) are violated, until the encounter ends, or until you enter a new stance, whichever comes first. After you use an action with the stance trait, you can't use another one for 1 round. You can enter or be in a stance only in encounter mode.
...
>
>  **Cantrips**: [[Spells/Acid Splash|_acid splash_]], [[Spells/Gouging Claw|_gouging claw_]], [[Spells/Produce Flame|_produce flame_]], [[Spells/Ray of Frost|_ray of frost_]], [[Spells/Tanglefoot|_tanglefoot_]], [[Spells/Telekinetic Projectile|_telekinetic projectile_]]  
> **1st-Level Spells**: [[Spells/Horizon Thunder Sphere|_horizon thunder sphere_]], [[Spells/Hydraulic Push|_hydraulic push_]], [[Spells/Ray of Enfeeblement|_ray of enfeeblement_]], [[Spells/Shocking Grasp|_shocking grasp_]], [[Spells/Snowball|_snowball_]]
...
Trained in [[Rules/Skills/Arcana]]  
 Trained in a number of additional skills equal to 2 plus your Intelligence modifier
...
You study spells so you can combine them with your attacks or solve problems that strength of arms alone can't handle. You can cast [[Magic/Traditions/Arcane|arcane]] spells using the Cast a Spell activity, and you can supply material, somatic, and verbal components when casting spells. Because you're a magus, you can draw replacement sigils with the tip of your weapon or your free hand for spells requiring material components, replacing them with somatic components instead of needing a [[Equipment/Material Component Pouch|material component pouch]].
...
Your hybrid study grants you additional spells that can enhance your power in combat. You gain two special 2nd-level studious spell slots, which can be used to prepare [[Spells/Gecko Grip|_gecko grip_]], [[Spells/Sure Strike|_sure strike_]], [[Spells/Water Breathing (Player Core)|_water breathing_]], and an additional spell depending on your hybrid study. You add any spells from this class feature to your spellbook. At 11th level, the extra slots increase to 3rd level and you add [[Spells/Haste (Player Core)|_haste_]] and an additional spell depending on your hybrid study. At 13th level, the extra slots increase to 4th level and you add [[Spells/Fly (Player Core)|_fly_]] and an additional spell depending on your hybrid study.

See specific [hybrid studies](HybridStudies.aspx) for more information.
...
Source on Archives of Nethys: [Magus](https://2e.aonprd.com/Classes.aspx?ID=17)
