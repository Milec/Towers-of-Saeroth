...
type: "class"
aon_id: "class-11"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=11"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
navigation:
  ...
  - "label Feats"
  - "url /classes/sorcerer/feats"
  - "label Sample Builds"
  - "url /classes/sorcerer/sample-builds"
  - "label Class Kit"
  - "url /classes/sorcerer/class-kit"
  - "label Focus Spells"
  - "url /classes/sorcerer/focus-spells"
  - "label Bloodlines"
  - "url /classes/sorcerer/bloodlines"
...
**Source** [[Sources/Core Rulebook]] pg. 190
...
Choose a bloodline that gives you your spellcasting talent. This choice determines the type of spells you cast and the spell list you choose them from, additional spells you learn, and additional trained skills. You also gain Focus Points and special focus spells based on your bloodline. The bloodlines presented in this book are as follows.
 ...
 Bloodlines can be found [here](Bloodlines.aspx?ID=)

### Sorcerer Spellcasting

Your bloodline provides you with incredible magical power. You can cast spells using the Cast a Spell activity, and you can supply material, somatic, and verbal components when casting spells (see [[Rules/Casting Spells]]). Because you're a sorcerer, you can usually replace material components with somatic components, so you don't need to use a [[Equipment/Material Component Pouch|material component pouch]].
...
### Swapping Spells in Your Repertoire
 ...
 As you gain new spells in your spell repertoire, you might want to replace some of the spells you previously learned. Each time you gain a level and learn new spells, you can swap out one of your old spells for a different spell of the same level. This spell can be a cantrip, but you can't swap out bloodline spells. You can also swap out spells by retraining during [[Rules/Downtime Mode|downtime]].
...
At 2nd level and every even-numbered level, you gain a [[Rules/Category Pages/Feats|sorcerer class feat]].
...
You have perfected the magic in your bloodline. Add two common 10th-level spells of your tradition to your repertoire. You gain a single 10th-level spell slot you can use to cast these spells, using sorcerer spellcasting. Unlike other spell slots, you don’t gain more 10th-level spells as you level up, and they can’t be used for abilities that let you cast spells without expending spell slots or abilities that give you more spell slots. You can take the [[Feats/Bloodline Perfection]] sorcerer feat to gain a second slot.
...
Source on Archives of Nethys: [Sorcerer](https://2e.aonprd.com/Classes.aspx?ID=11)
