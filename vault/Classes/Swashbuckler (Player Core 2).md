...
hp: 10
icon_image: "/Images/Class/Swashbuckler_Icon.png"
image:
  - "/Images/Classes/Iconic_Jirelle.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/swashbuckler"
  - "label Feats"
  - "url /classes/swashbuckler/feats"
  - "label Sample Builds"
  - "url /classes/swashbuckler/sample-builds"
  - "label Class Kit"
  - "url /classes/swashbuckler/class-kit"
  - "label Styles"
  - "url /classes/swashbuckler/styles"
...
**Source** [[Sources/Player Core 2]] pg. 158
...
Trained in [[Rules/Skills/Acrobatics (Player Core)|Acrobatics]]  
 Trained in one skill determined by your swashbuckler's style  
 Trained in a number of additional skills equal to 4 plus your Intelligence modifier
...
A list of all swashbuckler's styles can be found [here](Styles.aspx).
...
At 1st level and every even-numbered level, you gain a [[Rules/Category Pages/Feats|swashbuckler class feat]].
...
As a swashbuckler at the peak of your skill, you swell with confidence in every attack. Your proficiency rank for your swashbuckler class DC increases to master.
 ...
 When you Strike as part of a finisher or Opportune Riposte, you can give the Strike the failure effect from the Confident Finisher action, including the increase from [[Feats/Precise Finisher (Player Core 2)|Precise Finisher]] if you have that feat. You can do so only if the Strike uses a weapon or unarmed attack that you could use for Confident Finisher.
...
Source on Archives of Nethys: [Swashbuckler](https://2e.aonprd.com/Classes.aspx?ID=63)
