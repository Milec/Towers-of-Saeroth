...
type: "class"
aon_id: "class-12"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=12"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
hp: 6
icon_image: "/Images/Class/Wizard_Icon.png"
image:
  - "/Images/Classes/Iconic_Ezren.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/wizard"
  - "label Feats"
  - "url /classes/wizard/feats"
  - "label Sample Builds"
  - "url /classes/wizard/sample-builds"
  - "label Class Kit"
  - "url /classes/wizard/class-kit"
  - "label Focus Spells"
  - "url /classes/wizard/focus-spells"
  - "label Arcane Schools"
  - "url /classes/wizard/arcane-schools"
  - "label Arcane Theses"
  - "url /classes/wizard/arcane-theses"
...
**Source** [[Sources/Core Rulebook]] pg. 202
...
You likely try to stay out of the fray, carefully judging when to use your spells. You save your most powerful magic to incapacitate threatening foes and use your cantrips when only weaker foes remain. When enemies pull out tricks like [[Spells/Invisibility|_invisibility_]] or [[Spells/Fly|_flight_]], you answer with spells like [[Spells/Glitterdust|_glitterdust_]] or [[Spells/Earthbind|_earth bind_]], leveling the field for your allies.
...
Trained in the [[Equipment/Weapons/Club|club]], [[Equipment/Weapons/Crossbow|crossbow]], [[Equipment/Weapons/Dagger|dagger]], [[Equipment/Weapons/Heavy Crossbow|heavy crossbow]], and [[Equipment/Weapons/Staff|staff]]  
Trained in unarmed attacks
...
Through dedicated study and practice, you can harness arcane power to cast spells. You can cast arcane spells using the Cast a Spell activity, and you can supply material, somatic, and verbal components when casting spells (see [[Rules/Casting Spells]]).
...
### Spellbook
 ...
 Every arcane spell has a written version, usually recorded in a spellbook. You start with a [[Equipment/Spellbook (Blank)|spellbook]] worth 10 sp or less, which you receive for free and must study to prepare your spells each day. The spellbook contains your choice of 10 arcane cantrips and five 1st-level arcane spells. You choose these from the common spells on the [[Magic/Traditions/Arcane|arcane]] spell list or from other arcane spells you gain access to. Your spellbook's form and name are up to you. It might be a musty, leather-bound tome or an assortment of thin metal disks connected to a brass ring; its name might be esoteric, like _The Crimson Libram_, or something more academic, like _A Field Study in Practical Transmutation_.

 Each time you gain a level, you add two more arcane spells to your spellbook, of any level for which you have spell slots. You can also use the [[Rules/Skills/Arcana]] skill to add other spells that you find in your adventures (See [[Rules/Sidebars/Crafting Example|Learn a Spell]]).
...
Arcane schools can be found [here](ArcaneSchools.aspx)
...
Arcane theses can be found [here](ArcaneThesis.aspx).
...
At 2nd level and every even-numbered level thereafter, you gain a wizard [[Rules/Category Pages/Feats|class feat]].
...
Source on Archives of Nethys: [Wizard](https://2e.aonprd.com/Classes.aspx?ID=12)
