...
type: "class"
aon_id: "class-16"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=16"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
hp: 6
icon_image: "/Images/Class/Witch_Icon.png"
image:
  - "/Images/Classes/Iconic_Feiya.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/witch"
  - "label Feats"
  - "url /classes/witch/feats"
  - "label Sample Builds"
  - "url /classes/witch/sample-builds"
  - "label Class Kit"
  - "url /classes/witch/class-kit"
  - "label Focus Spells"
  - "url /classes/witch/focus-spells"
  - "label Lessons"
  - "url /classes/witch/lessons"
  - "label Patron Themes"
  - "url /classes/witch/patron-themes"
...
**Source** [[Sources/Advanced Player's Guide]] pg. 94
...
>
>  **[[Traits/Hex]]**: A hex is a short-term effect generated on the fly from your patron's magic, requiring your familiar to draw from your patron. As such, you can cast only one spell with the hex trait each turn; attempts to cast a second hex spell on the same turn fail and the spellcasting actions are lost.
>
...
You weren't born with the power to cast spells, nor have you spent years in devotion to tomes, deities, or mystical secrets. Your power comes through a potent being that has chosen you as their vessel to carry forth some agenda in the world. This entity is typically mysterious and distant, revealing little of their identity and motivations, and they grant you spells and other magical powers through a familiar, which serves as a conduit for their power.
 ...
 At 1st level, choose your patron's theme, which determines your spellcasting tradition, a skill, a special cantrip you gain, and a spell added to your familiar. The patron themes can be found [here](Patrons.aspx).

### Familiar

Your patron has sent you a familiar, a mystical creature that teaches you and facilitates your spells. This familiar follows the rules [here](Familiars.aspx), though as it's a direct conduit between you and your patron, it's more powerful than other familiars. Your familiar gains an extra familiar ability, and gains another extra ability at 6th, 12th, and 18th levels.
...
Focus spells don't require spell slots, and you can't cast them using spell slots. Certain feats can give you more focus spells and increase the size of your focus pool, though your focus pool can never hold more than 3 Focus Points. The full rules for focus spells appear [[Rules/Focus Spells|here]].

You learn the [[Spells/Phase Familiar|_phase familiar_]] hex, which you can cast as a reaction to protect your familiar from harm. You learn most other hexes from witch lessons.
...
At 2nd level and every 2 levels thereafter, you gain a [[Rules/Category Pages/Feats|witch class feat]].
