...
type: "class"
aon_id: "class-14"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=14"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
hp: 8
icon_image: "/Images/Class/Oracle_Icon.png"
image:
  - "/Images/Classes/Iconic_Korakai.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/oracle"
  - "label Feats"
  - "url /classes/oracle/feats"
  - "label Sample Builds"
  - "url /classes/oracle/sample-builds"
  - "label Class Kit"
  - "url /classes/oracle/class-kit"
  - "label Focus Spells"
  - "url /classes/oracle/focus-spells"
  - "label Mysteries"
  - "url /classes/oracle/mysteries"
...
**Source** [[Sources/Advanced Player's Guide]] pg. 66
...
>
>  **[[Traits/Cursebound]]**: Spells with this trait increase the severity of your oracular curse when cast. Usually only revelation spells have this trait. You can't cast a cursebound spell if you don't have an oracular curse.
>
>  **[[Traits/Fortune]] and [[Traits/Misfortune]]**: Fortune and misfortune effects can alter how you roll your dice. You can never have more than one fortune and one misfortune effect come into play on a single roll. If multiple fortune effects would apply, you must pick which to use. If two misfortune effects apply, the GM decides which is worse and applies it. If both a fortune effect and a misfortune effect would apply to the same roll, the two cancel each other out, and you roll normally.
>
...
### Revelation Spells
 ...
 You learn two revelation spells at 1st level. The first is an initial revelation spell determined by your mystery. The second is an initial domain spell you select from one of the domains associated with your mystery, which you cast as a revelation spell, causing it to gain the [[Traits/Cursebound|cursebound]] trait.
...
### Oracular Curse
 ...
 Your curse has the [[Traits/Curse|curse]], [[Traits/Divine|divine]], and [[Traits/Necromancy|necromancy]] traits. You can't mitigate, reduce, or remove the effects of your oracular curse by any means other than Refocusing and resting for 8 hours. For example, if your curse makes creatures [[Rules/Conditions/Concealed|concealed]] from you, you can't negate that concealed condition through a magic item or spell, such as [[Spells/True Strike|_true strike_]] (though you would still benefit from the other effects of that item or spell). Likewise, [[Spells/Remove Curse|_remove curse_]] and similar spells don't affect your curse at all.

### Oracle Feats  *Level 2*

At 2nd level and every 2 levels thereafter, you gain an [[Rules/Category Pages/Feats|oracle class feat]].
...
You have mastered a perilous balance between the conflicting divine powers of your mystery, gaining the power to change your fate, but straining both body and soul. When you cast a revelation spell while affected by your major curse, your curse intensifies to an extreme effect instead of overwhelming you. All mysteries share the same effects for their extreme curse.
 ...
 When affected by your extreme curse, you become [[Rules/Conditions/Doomed|doomed 2]] (or increase your doomed condition by 2 if you were already doomed). Once every 10 minutes, when you fail an attack roll, skill or Perception check, or saving throw, you can reroll it and use the second result. The reroll has the [[Traits/Fortune|fortune]] trait and doesn't require you to spend an action, meaning you can use the reroll even if you can't act. These effects are in addition to all the effects of your major curse, and they can't be removed by any means until you Refocus to reduce your curse to its minor effect.

 If you cast a revelation spell while under the effects of this extreme curse, you are overwhelmed by your curse, and you remain doomed 2 even if you [[Actions/Refocus]]. Additionally, if you spend at least 3 Focus Points before you again Refocus, you recover 3 Focus Points when you Refocus instead of 1.
...
You now fully grasp the nature of the divine power behind your mystery, allowing you to work magic akin to miracles. Add two common 10th-level divine spells to your repertoire. You gain a single 10th-level spell slot you can use to cast one of those two spells using oracle spellcasting. You don't gain more 10th-level spells as you level up, unlike other spell slots, and you can't use 10th-level slots with abilities that give you more spell slots or that let you cast spells without expending spell slots. You can take the [[Feats/Oracular Providence]] feat to gain a second slot.

---

Source on Archives of Nethys: [Oracle](https://2e.aonprd.com/Classes.aspx?ID=14)
