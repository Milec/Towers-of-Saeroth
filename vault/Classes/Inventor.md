...
type: "class"
aon_id: "class-71"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=71"
tags:
  - pf2e/class
  - rarity/uncommon
  - trait/uncommon
...
hp: 8
icon_image: "/Images/Class/Inventor_Icon.png"
image:
  - "/Images/Classes/Iconic_Droven.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/inventor"
  - "label Feats"
  - "url /classes/inventor/feats"
  - "label Sample Builds"
  - "url /classes/inventor/sample-builds"
  - "label Class Kit"
  - "url /classes/inventor/class-kit"
  - "label Innovations"
  - "url /classes/inventor/innovations"
...
**Source** [[Sources/Guns & Gears]] pg. 16

_[**PFS Note**](https://2e.aonprd.com/pathfinder-society) All Pathfinder Society agents have access to the Inventor class; however, all inventor characters treat updates to the class chassis and feats as errata, and must implement them immediately._
...
>
>
> [[Traits/Gadget (Guns & Gears (Remastered))|**Gadget**:]] Gadgets are consumable technological inventions with innovative uses.
>
> [[Traits/Modification (Guns & Gears (Remastered))|**Modification**]]: An ability with this trait alters your innovation’s construction. If you have the reconfigure class feature, you can retrain these feats more easily.
>
> **[[Traits/Unstable (Guns & Gears (Remastered))|Unstable]]:** Unstable actions use experimental applications of your innovation that even you can’t fully predict, and that are hazardous to your innovation (and potentially you). When you take an unstable action, attempt a DC 15 [[Rules/Flat Checks|flat check]] immediately after applying its effects. On a failure, the innovation malfunctions in a spectacular (though harmless) fashion, such as a belch of smoke or shower of sparks, and it becomes incapable of being used for further unstable actions. On a critical failure, you also take an amount of fire damage equal to your level. As the innovation’s creator, you can spend 10 minutes retuning your innovation and making adjustments to return it to functionality, at which point you can use unstable actions with that innovation again.
>
...
Trained in [[Rules/Skills/Crafting (Player Core)|Crafting]]  
Trained in a number of additional skills equal to 3 plus your Intelligence modifier
...
While you're always creating inventions, there's one that represents your preeminent work, the one that you hope—with refinement—might change the world. Choose one innovation. Your innovation's level is equal to your level. If your innovation is destroyed, you can spend 1 day of downtime and attempt a [[Rules/Sidebars/Crafting Example|Crafting]] check with a [[Rules/Level-Based DCs|high DC for your level]]; on a success, you rebuild it. An innovation only works due to your constant maintenance and tinkering, and therefore has no market Price.

Innovations can be found [here](Innovations.aspx).

### Explode

Your innovation is a creation barely held together by your own engineering, always on the edge of completely falling apart. Though this adds risk, it also means you can coax it to perform far beyond its design specifications using special [[Traits/Unstable (Guns & Gears (Remastered))|unstable]] actions.
...
You are constantly inventing, and your skill at crafting is unimpeachable. You gain the [[Feats/Inventor]] skill feat, even if you don’t meet its prerequisites.

### Shield Block

You gain the [[Feats/Shield Block]] general feat, a reaction that lets you reduce damage with your shield.

### Inventor Feats

At 1st level and every even-numbered level, you gain an [[Rules/Category Pages/Feats|inventor class feat]]. Some features and feats use an assortment of gizmos you keep on your person. For simplicity, these are left abstract, but if you are deprived of your gear for some reason, you might lose access to many feats and features, subject to GM discretion.
...
You’ve increased your skill in crafting, and you can put your devices into a more powerful state of overdrive. You become an expert in [[Rules/Skills/Crafting (Player Core)|Crafting]], and on a successful use of Overdrive, you increase the additional damage by 1.
...
You’ve become an expert in all crafts and are always adjusting your inventions. You can attempt to change the modifications on your innovation by spending 1 day of downtime tinkering with it and attempting a [[Rules/Skills/Crafting (Player Core)|Crafting]] check, with a high DC for your level. On a success, you can change one modification you’ve chosen for your innovation to a different modification of the same kind (initial, breakthrough, or revolutionary).
...
Your mastery of invention and crafting enhances your Overdrive even further. You become a master in [[Rules/Skills/Crafting (Player Core)|Crafting]], and on a successful Overdrive, you increase the additional damage by a total of 2, replacing the increase from expert overdrive.
...
- **Chill ([[Traits/Cold (Player Core)|Cold]]):** Your innovation rapidly absorbs heat, creating an intense chill.
- **Ignition ([[Traits/Fire (Player Core)|Fire]]):** Your innovation shoots out jets of searing flame.
- **Jolt ([[Traits/Electricity (Player Core)|Electricity]]):** Your innovation jolts foes with charges of electricity.
...
- **Vitriol ([[Traits/Acid (Player Core)|Acid]]):** Your innovation releases spurts of caustic acid.
...
If you have a medium or heavy armor innovation, you gain access to the [[Rules/Critical Specialization|critical specialization]] effect with your armor innovation.
...
Your attention to detail lets you remain alert to threats around you. Your proficiency rank for [[Rules/Perception (Player Core)|Perception]] increases to expert.

### Complete Configuration  *Level 13*
...
### Inventor Weapon Mastery  *Level 13*
...
### Legendary Overdrive  *Level 15*

Your peerless inventing and Crafting ability has supercharged your Overdrives. You become legendary in [[Rules/Skills/Crafting (Player Core)|Crafting]], and on a successful Overdrive, you increase the additional damage by a total of 3, replacing the increase from master overdrive.

### Revolutionary Innovation  *Level 15*

You are an unparalleled genius and have discovered a technique that will revolutionize your chosen field—or at least for the time being, your [innovation](Innovations.aspx)! Choose a revolutionary modification to apply to your innovation. You can also choose an initial or breakthrough modification of the same type instead, if you prefer.

### Inventive Mastery  *Level 17*
...
Source on Archives of Nethys: [Inventor](https://2e.aonprd.com/Classes.aspx?ID=71)
