...
hp: 8
icon_image: "/Images/Class/Animist_Icon.png"
image:
  - "/Images/Classes/Iconic_Samo.webp"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/animist"
  - "label Feats"
  - "url /classes/animist/feats"
  - "label Sample Builds"
  - "url /classes/animist/sample-builds"
  - "label Class Kit"
  - "url /classes/animist/class-kit"
...
Trained in [[Rules/Skills/Religion (Player Core)|Religion]] and either [[Rules/Skills/Nature (Player Core)|Nature]] or [[Rules/Skills/Occultism (Player Core)|Occultism]]  
 Trained in a number of additional skills equal to 2 plus your Intelligence modifier
...
At 1st level, you choose an [animistic practice](Practices.aspx) that influences the way your power grows and develops, and you gain its first invocation. At 9th level, you gain its second invocation, and at 17th, you gain its third.

### Animist Feats  *Level 2*

At 2nd level and every even-numbered level, you gain an [[Rules/Category Pages/Feats|animist class feat]].
