...
hp: 12
icon_image: "/Images/Class/Barbarian_Icon.png"
image:
  - "/Images/Classes/Iconic_Amiri.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/barbarian"
  - "label Feats"
  - "url /classes/barbarian/feats"
  - "label Sample Builds"
  - "url /classes/barbarian/sample-builds"
  - "label Class Kit"
  - "url /classes/barbarian/class-kit"
  - "label Instincts"
  - "url /classes/barbarian/instincts"
...
**Source** [[Sources/Player Core 2]] pg. 70
...
>
>  **[[Traits/Rage (Player Core 2)|Rage]]:** You must be raging to use abilities with the rage trait, and they end automatically when you stop raging.
...
Trained in [[Rules/Sidebars/Multiple Attacks with Athletics (Player Core)|Athletics]]  
 Trained in a number of additional skills equal to 3 plus your Intelligence modifier
...
Instincts can be found [here](Instincts.aspx).

### Barbarian Feats

At 1st level and every even-numbered level thereafter, you gain a [[Rules/Category Pages/Feats|barbarian class feat]].
...
The urge to fight drives you ever forward. You gain a +5-foot status bonus to your Speed. This bonus increases to +10 feet while you’re [[Actions/Rage (Player Core 2)|raging]].
...
Your fury makes your weapons lethal. Your proficiency ranks for simple weapons, martial weapons, and [[Traits/Unarmed (Player Core)|unarmed]] attacks increase to expert. While [[Actions/Rage (Player Core 2)|raging]], you have the critical specialization benefits for melee weapons and unarmed attacks.
...
Repeated exposure and toughened skin allow you to fend off harm. While [[Actions/Rage (Player Core 2)|raging]], you gain [[Rules/Resistance (Player Core)|resistance]] equal to 3 + your Constitution modifier to damage types based on your instinct.
...
Your rage intensifies and lets you hit harder at the start of a fight. Your proficiency rank for your barbarian class DC increases to expert. In addition, when you use [[Actions/Quick-Tempered]], the first Strike you make during your first turn deals additional damage equal to your [[Actions/Rage (Player Core 2)|Rage]] damage.
...
Your rage makes you even more effective with the weapons you wield. Your proficiency ranks for simple weapons, martial weapons, and [[Traits/Unarmed (Player Core)|unarmed]] attacks increase to master.
...
Your instinct heightens each of your senses further. Your proficiency rank for [[Rules/Perception (rules-2298)|Perception]] increases to master.

### Revitalizing Rage  *Level 17*

Your rage sustains you more frequently, leaving you ready to jump into battle anew. Instead of needing to wait 1 minute before you can gain [[Rules/Temporary Hit Points (Player Core)|temporary Hit Points]] from [[Actions/Rage (Player Core 2)|Rage]] again, you need only to spend at least one full turn not in a Rage.
...
Your Strikes are so devastating that you hardly care about resistance, and your barbarian abilities are unparalleled. Your proficiency rank for your barbarian class DC increases to master. Your melee Strikes ignore up to 10 [[Rules/Resistance (Player Core)|resistance]] to the physical damage they deal.

---

Source on Archives of Nethys: [Barbarian](https://2e.aonprd.com/Classes.aspx?ID=57)
