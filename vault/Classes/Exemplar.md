...
hp: 10
icon_image: "/Images/Class/Exemplar_Icon.png"
image:
  - "/Images/Classes/Iconic_Nahoa.webp"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/exemplar"
  - "label Feats"
  - "url /classes/exemplar/feats"
  - "label Sample Builds"
  - "url /classes/exemplar/sample-builds"
  - "label Class Kit"
  - "url /classes/exemplar/class-kit"
...
**Traits** [[Traits/Rare (Player Core)|Rare]]

**Source** [[Sources/War of Immortals]] pg. 28

_[**PFS Note**](https://2e.aonprd.com/pathfinder-society) All Pathfinder Society agents have access to the Exemplar class._
...
At 1st level and every even-numbered level thereafter, you gain an [[Rules/Category Pages/Feats|exemplar class feat]].
...
As your story unfolds, your personality and deeds begin to shape the potential of your divine spark. You come to bear an epithet—a word or phrase that seems to always stick in the mind of those describing you. Your epithets grant you additional abilities, especially when your divine spark is brought to the surface.
 ...
 You first gain a root epithet to describe an aspect of your personality. This grants you a skill, as well as a special effect that occurs when you Spark Transcendence. If you are already trained in the granted skill, you become trained in a different skill of your choice, as normal. An effect that occurs after you Spark Transcendence happens immediately after your transcendence action is completely resolved. Choose one [Root Epithet.](Epithets.aspx?Type=Root)
...
Your divinity has grown in power along with your deeds, allowing you to begin claiming dominion over aspects of creation. Choose one [Dominion Epithet](Epithets.aspx?Type=Dominion). Each one grants a critical specialization ability you can use instead of any others you might have access to, and an ability you can use when you Spark Transcendence. You can benefit from no more than one epithet ability each time you Spark Transcendence. Some epithets grant additional benefits, such as feats.
...
The litany of heroic deeds left in your wake has caused your divine spark to blaze bright enough that it now illuminates your legacy. Choose one [Sovereignty Epithet](Epithets.aspx?Type=Sovereignty), which grants you an ability you can use when you Spark Transcendence. You can benefit from no more than one epithet ability each time you Spark Transcendence.
...
Source on Archives of Nethys: [Exemplar](https://2e.aonprd.com/Classes.aspx?ID=65)
