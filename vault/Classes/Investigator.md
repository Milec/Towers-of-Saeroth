...
type: "class"
aon_id: "class-13"
aon_url: "https://2e.aonprd.com/Classes.aspx?ID=13"
tags:
  - pf2e/class
  - rarity/common
attack_proficiency:
...
hp: 8
icon_image: "/Images/Class/Investigator_Icon.png"
image:
  - "/Images/Classes/Iconic_Quinn.png"
is_standard_ancestry_feat: false
navigation:
  - "label Details"
  - "url /classes/investigator"
  - "label Feats"
  - "url /classes/investigator/feats"
  - "label Sample Builds"
  - "url /classes/investigator/sample-builds"
  - "label Class Kit"
  - "url /classes/investigator/class-kit"
  - "label Methodologies"
  - "url /classes/investigator/methodologies"
...
**Source** [[Sources/Advanced Player's Guide]] pg. 54
...
Methodologies can be found [here](Methodologies.aspx?ID=).

### Investigator Feats

At 1st level and every even-numbered level, you gain an [[Rules/Category Pages/Feats|investigator class feat]].
...
You can recall pertinent facts on topics that aren't your specialty. Your proficiency bonus to untrained skill checks to [[Actions/Recall Knowledge]] is equal to your level instead of +0.
...
Source on Archives of Nethys: [Investigator](https://2e.aonprd.com/Classes.aspx?ID=13)
