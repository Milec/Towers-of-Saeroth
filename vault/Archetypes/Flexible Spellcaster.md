---
title: "Flexible Spellcaster"
type: "archetype"
aon_id: "archetype-99"
aon_url: "https://2e.aonprd.com/Archetypes.aspx?ID=99"
tags:
  - pf2e/archetype
  - rarity/common
archetype:
...
# Flexible Spellcaster  *Archetype 2*

**Source** [[Sources/Secrets of Magic]] pg. 209
...
**Prerequisites**: You must have a class, such as [[Classes/Class Features/Ancestry and Background (class-feature-111)|clerics]], [[Classes/Class Features/Ancestry and Background (class-feature-129)|druids]], [[Classes/Class Features/Ancestry and Background (class-feature-392)|witches]], and [[Classes/Class Features/Ancestry and Background (class-feature-282)|wizards]], that prepares spells in spell slots using the same number of prepared spells per day.

**Flexible Spellcaster Adjustments**: You learn spells as normal for your class (a wizard uses a [[Equipment/Spellbook (Blank)|spellbook]], a witch teaches spells to their [familiar](Familiars.aspx), and so on), but change your spellcasting from your class as follows.
...
- You can cast any of the spells in your collection by using a spell slot of an appropriate level. For instance, if you were level 1 and had [[Spells/Feather Fall|_feather fall_]] and [[Spells/Magic Missile|_magic missile_]] in your spell collection, you could cast _feather fall_ twice that day, _magic missile_ twice, or each spell once.
...
## Adjudicating Class Feats And Features
 ...
 Some of your class feats or features might rely on the fact that you prepare spells in spell slots. While some class feats might no longer work or be necessary with the flexible spellcaster archetype, in many cases you can make a simple replacement and continue using the class feat. The following class feats simply require replacing “a spell you have prepared” or “a prepared spell” for “a spell in your collection” or “a spell slot.” For example, in [[Feats/Counterspell]], you'd replace “a spell you have prepared” in the trigger for “a spell in your collection” and “expend a prepared spell” for “expend a spell slot.” Similarly, in arcane bond, you'd replace “cast one spell you prepared today and already cast” with “cast one spell in your collection you've already cast today.”

 The Counterspell and [[Feats/Leyline Conduit]] feats in the _Core Rulebook_ need these substitutions, as does [[Feats/Form Retention]] from the _Advanced Player's Guide_. [[Feats/Spell Mastery]] provides additional restricted spells, like divine font or specialist spells; you can take it, but it doesn't add to your collection and works like normal prepared spells.

## Disallowed Feats

 The following feats from the _Core Rulebook_ aren't available for a flexible spellcaster: [[Feats/Call of the Wild]], [[Feats/Clever Counterspell]], [[Feats/Infinite Possibilities]], [[Feats/Reprepare Spell]], and [[Feats/Spell Combination]]. The disallowed feats from the _Advanced Player's Guide_ are as follows: [[Feats/Elemental Summons]], [[Feats/Miraculous Possibility]], [[Feats/Rites of Convocation]], and [[Feats/Rites of Transfiguration]].

[[Rules/Flexible Preparation|Click here for more rules on using this archetype.]]
...
Source on Archives of Nethys: [Flexible Spellcaster](https://2e.aonprd.com/Archetypes.aspx?ID=99)
