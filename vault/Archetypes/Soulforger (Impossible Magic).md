...
level: 2
pfs: "Restricted"
prerequisite: "or ability to cast divine spells"
...
[[Rules/Soulforger|Click here for more rules on using this archetype.]]
...
**Source** [[Sources/Secrets of Magic]] pg. 236
...
Melee weapon only. The weapon gains the [[Traits/Thrown|thrown 30 feet]] trait and has the [[Equipment/Returning|_returning_]] rune (even if it already has its maximum number of property runes).
...
You gain a +2 status bonus to your [[Rules/Skills/Intimidation]] checks and don't take any penalties for not sharing a language when [[Actions/Demoralize|Demoralizing]] foes who can perceive your armament's essence form. When you manifest the essence form, you can attempt to Demoralize an enemy who can perceive the manifestation.
...
Any status penalties you take from the following conditions are 1 less than their condition's value: [[Rules/Conditions/Clumsy|clumsy]], [[Rules/Conditions/Drained|drained]], [[Rules/Conditions/Enfeebled|enfeebled]], [[Rules/Conditions/Frightened|frightened]], [[Rules/Conditions/Sickened|sickened]], [[Rules/Conditions/Stupefied|stupefied]]. This doesn't change the actual condition value, or any other effects of the condition (such as stupefied's disruption and its DC).
...
**Traits** [[Traits/Necromancy]], [[Traits/Negative]]

**Source** [[Sources/Secrets of Magic]] pg. 237

Your Strikes deal an additional 1d4 negative damage. Once while the armament is manifested, you can cast [[Spells/Harm|_harm_]] as an innate spell, with a level equal to half your level rounded up.

**Corruption Flaw** Reduce any damage you would deal by half your level.

## Heroic Heart

**Traits** [[Traits/Enchantment]], [[Traits/Mental]]
...
**Traits** [[Traits/Healing]], [[Traits/Necromancy]], [[Traits/Positive]]

**Source** [[Sources/Secrets of Magic]] pg. 237

You gain [[Bestiary/Abilities/Fast Healing|fast healing]] equal to half your level. You can cast [[Spells/Heal|_heal_]] once as an innate spell with a level equal to half your level rounded up.
...
Armor or shield only. You gain a +2 status bonus to saving throws and AC against spells. If you're 5th level or higher, you can cast [[Spells/Dispel Magic|_dispel magic_]] once as an innate spell. The spell level is equal to 1 lower than half your level rounded up (2nd level if you're 5th or 6th level, and so on).
...
Weapon only. Any time you hit with the soulforged weapon, the target takes a –10-foot penalty to its Speeds for 1 round. On a critical hit, the creature is [[Rules/Conditions/Immobilized|immobilized]] for 1 round instead.
...
Shield only. The shield gains a +2 status bonus to its Hardness and gains temporary Hit Points equal to your level + 2 that last until the essence effect ends. If you don't have the [[Feats/Shield Block]] reaction, you gain it while your shield is manifested.

**Corruption Flaw** When you take damage while [[Actions/Raise a Shield|Raising a Shield]] or use Shield Block, attempt a DC 5 flat check. If you fail, the shield is Dismissed if it's your soulforged armament or Dropped if it's a different shield.

---

Source on Archives of Nethys: [Soulforger](https://2e.aonprd.com/Archetypes.aspx?ID=393)
