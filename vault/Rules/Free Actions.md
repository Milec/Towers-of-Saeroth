...
type: "rules"
aon_id: "rules-63"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=63"
tags:
  - pf2e/rules
  - rarity/common
breadcrumbs:
...
next_link:
  - "label Activities"
  - "url /Rules.aspx?ID=64"
previous_link:
  - "label <%ACTION.TYPES#5%%> Reactions"
  - "url /Rules.aspx?ID=62"
...
**Source** [[Sources/Core Rulebook]] pg. 17
...
Source on Archives of Nethys: [Free Actions](https://2e.aonprd.com/Rules.aspx?ID=63)
