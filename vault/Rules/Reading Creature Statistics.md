...
type: "rules"
aon_id: "rules-786"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=786"
tags:
  - pf2e/rules
  - rarity/common
breadcrumbs:
...
next_link:
  ...
  - "url /Rules.aspx?ID=787"
previous_link:
  - "label Appendix"
  - "url /Rules.aspx?ID=773"
...
**Traits** Uncommon Alignment Abbreviation Size Other Traits
...
**Melee** single action (traits; some weapon traits, such as [[Traits/Deadly|deadly]], include their calculations for convenience) The name of the weapon or unarmed attack the creature uses for a melee Strike, followed by the attack modifier and traits in parentheses. If a creature has any abilities or gear that would affect its attack modifier, such as a weapon with a [[Equipment/Weapon Potency|_+1 weapon potency_]] rune, those calculations are already included, **Damage** amount and damage type, plus any additional effects (this entry is **Effect** if the Strike doesn’t deal damage).  
...
Source on Archives of Nethys: [Reading Creature Statistics](https://2e.aonprd.com/Rules.aspx?ID=786)
