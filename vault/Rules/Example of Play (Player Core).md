...
# Example of Play  *Rules*

**Source** [[Sources/Player Core]] pg. 12

The following example is presented to give you a better idea of how the game of Pathfinder is played. In this adventure, Erik is the GM. Luis is playing Valeros, a daring [[Ancestries/Human (Player Core)|human]] [[Classes/Class Features/Ancestry and Background (class-feature-688)|fighter]]; Shay is playing Merisiel, a deadly [[Ancestries/Elf (Player Core)|elven]] [[Classes/Class Features/Ancestry and Background (class-feature-739)|rogue]], and Jessica is taking on the role of Kyra, Merisiel's wife and a compassionate human [[Classes/Class Features/Ancestry and Background (class-feature-646)|cleric]] of [[Setting/Deities/Sarenrae (Divine Mysteries)|Sarenrae]]. The group has chosen to investigate disappearances in a local mine.
...
**Kyra (Jessica):** I call upon the sacred light of Sarenrae and cast a golden [[Spells/Light (Player Core)|_light_]] spell ahead of us.  
...
**Merisiel (Shay):** I have [[Rules/Low-Light Vision (Player Core)|low-light vision]], so I should go first to make sure it's safe. I put away my daggers so I can stealthily climb down the ladder, looking for traps as I go.  
**Erik:** Roll your [[Rules/Sidebars/Being Stealthy (Player Core)|Stealth]] check, but [[Actions/Search (Player Core)|looking for traps]] is a [[Traits/Secret (Player Core)|secret]] check, so I'll roll for that. What's your [[Rules/Perception (rules-2298)|Perception]] modifier?  
**Merisiel (Shay):** I have a +6 to Perception, and I rolled an 18 on Stealth.

Erik rolls a d20 behind his GM screen, hidden from the players' view, and gets a 17 on the die for a total of 23. There are no traps in the area that Merisiel is looking, but the result is more than enough to see a frightened [[Ancestries/Kobold (Player Core 2)|kobold]] hiding behind a mine cart. Due to Merisiel's Stealth check, the kobold does not see her descend the ladder.
...
**Valeros (Luis):** I have a +3 [[Rules/Skills/Diplomacy (Player Core)|Diplomacy]]. I'll call out to her.  
**Erik:** What do you say?  
**Valeros (Luis):** "Hello friend! Don't be scared, we're here to help!" I rolled a 15 on my Diplomacy check.  
**Erik:** Okay! The kobold seems startled, but then runs to you for safety. "Oh! Thank [[Setting/Deities/Torag (Divine Mysteries)|Torag]] you're here!"  
...
**Erik:** You can get to within 15 feet of it with one [[Actions/Stride (Player Core)|Stride]] action.  
...
Shay rolls a 13 and adds 8, due to Merisiel's skill at thrown daggers, for a total of 21, but the [[Rules/Range and Reach (Player Core)|range]] means the attack takes a –2 penalty for a result of 19. Erik consults his notes to learn that the monster has an AC of 15.
...
**Kyra (Jessica):** Gross! Okay, this creature looks [[Traits/Undead (Player Core)|undead]], do I know anything about that?  
**Erik:** You can think back to your cleric training to [[Actions/Recall Knowledge (Player Core)|Recall Knowledge]], spending one action. It's a secret check, so what's your [[Rules/Skills/Religion (Player Core)|Religion]] modifier?  
**Kyra (Jessica):** It's +7.

Erik rolls a 12, adding Kyra's +7 with Religion to get a total of 19 against the DC of 16.

**Erik:** Your initial suspicion was correct. This is a [[Bestiary/Families/Zombie (Monster Core)|zombie]]. This one appears to be larger because it was enhanced by magic. Because you already had a hunch this was a zombie, why don't you ask another question?  
...
Merisiel's daggers have a trait called [[Traits/Versatile (Player Core)|versatile]] (slashing), which allow her to deal slashing damage instead of piercing if she chooses. Unfortunately, she didn't know that doing so would be more effective when she acted!

**Kyra (Jessica):** I am going to spend my last two actions to cast [[Spells/Runic Weapon|_runic weapon_]] on Valeros's sword. It gives him a +1 bonus to attack rolls and another die of damage. "Valeros, get that thing!"  
**Valeros (Luis):** I do what she says and get it! I spend one action to [[Actions/Raise a Shield (Player Core)|raise my shield]] and use my final two actions to make a [[Feats/Sudden Charge (Player Core)|Sudden Charge]]!
...
**Erik:** And that's a critical failure, go figure. You are [[Rules/Conditions/Sickened (Player Core)|sickened]] 1, which gives you a –1 penalty to d20 rolls and AC.  
...
Source on Archives of Nethys: [Example of Play](https://2e.aonprd.com/Rules.aspx?ID=2009)
