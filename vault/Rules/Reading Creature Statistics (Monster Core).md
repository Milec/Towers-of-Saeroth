---
title: "Reading Creature Statistics"
type: "rules"
aon_id: "rules-3260"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=3260"
tags:
  - pf2e/rules
  - rarity/common
breadcrumbs:
...
next_link:
  - "label Roleplaying Creatures"
  - "url /Rules.aspx?ID=3261"
previous_link:
  - "label Chapter 5: Treasure Trove"
  - "url /Rules.aspx?ID=3135"
...
# Reading Creature Statistics  *Rules*

**Source** [[Sources/Monster Core]] pg. 5
...
Some abilities are abbreviated in stat blocks, with their full text in the [Ability Glossary](MonsterAbilities.aspx).  

### Creature Name  *Level*

**Traits** RaritySizeOther Traits
...
**Melee** single action (traits; some weapon traits, such as [[Traits/Deadly (Player Core)|deadly]], include their calculations for convenience) The name of the weapon or unarmed attack the creature uses for a melee Strike, followed by the attack modifier and traits in parentheses. If a creature has any abilities or gear that would affect its attack modifier, such as a weapon with a [[Equipment/Weapon Potency (GM Core)|_+1 weapon potency_]] rune, those calculations are already included, **Damage** amount and damage type, plus any additional effects (this entry is **Effect** if the Strike doesn’t deal damage).  
**Ranged** single action As Melee, but also lists range or range increment with traits, **Damage** as Melee.  
...
**Innate Spells** These are listed like other spells, but can also include constant, at-will, and focus spells. If the creature has a focus spell as an innate spell, it works like other innate spells with listed uses, rather than costing Focus Points. Spells that can be used an unlimited number of times list “(at will)” after the spell’s name. Constant spells appear at the end, separated by rank. Rules for [[Bestiary/Abilities/Constant Spells (Monster Core)|constant]] and [[Bestiary/Abilities/At-Will Spells (Monster Core)|at-will]] spells appear in the [Ability Glossary](MonsterAbilities.aspx).  
...
Source on Archives of Nethys: [Reading Creature Statistics](https://2e.aonprd.com/Rules.aspx?ID=3260)
