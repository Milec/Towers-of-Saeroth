...
type: "rules"
aon_id: "rules-3120"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=3120"
tags:
  - pf2e/rules
  - rarity/common
breadcrumbs:
...
next_link:
  - "label Piloting a Vehicle"
  - "url /Rules.aspx?ID=3126"
previous_link:
  - "label Movement and Heading"
  - "url /Rules.aspx?ID=3119"
...
>
>  Powered by the measured release of energy stored in springs via winding, clockwork propulsion is a fragile thing of mechanical beauty and wonderous engineering. Clockwork vehicles can often be piloted with the [[Rules/Sidebars/Crafting Example|Crafting]] skill.
>
...
>
>  A creature can attempt to [[Actions/Disable a Device]] to wind a clockwork vehicle down (with a DC listed in the wind-up entry). For each success, the clockwork vehicle loses 10 minutes of operational time. This can be done even if the clockwork vehicle is in standby mode.
>
>  [[Rules/Conditions/Broken]] clockwork vehicles have difficulty holding energy. The first time each round a broken clockwork vehicle moves, it must make a DC 5 flat check. On a failure, it loses 10 minutes of operational time.
>
>
>
...
Source on Archives of Nethys: [Propulsion](https://2e.aonprd.com/Rules.aspx?ID=3120)
