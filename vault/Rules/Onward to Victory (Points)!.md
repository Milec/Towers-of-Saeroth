...
next_link:
  - "label Being in Command"
  - "url /Rules.aspx?ID=3438"
previous_link:
  - "label What Do the Heroes Do?"
  - "url /Rules.aspx?ID=3436"
...
# Onward to Victory (Points)!  *Rules*

**Source** [[Sources/Battlecry!]] pg. 202

The [[Rules/Victory Points (GM Core)|Victory Point]] subsystem is particularly well suited for war campaigns—it might not even need a change of name! Typically, you’ll want to use Victory Points when the characters have sufficient power or strategic pull to determine the outcome of the battle. Campaigns, especially about the futility or absurdity of war, should leave them out when the party can’t make the difference between victory and defeat.
...
Source on Archives of Nethys: [Onward to Victory (Points)!](https://2e.aonprd.com/Rules.aspx?ID=3437)
