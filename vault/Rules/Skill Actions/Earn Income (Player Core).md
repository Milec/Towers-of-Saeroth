...
# Earn Income (Trained)  *General Skill Action*

**Source** [[Sources/Player Core]] pg. 228
...
In some cases, the GM might let you use a different skill to Earn Income through specialized work. Usually, this is scholarly work, such as using [[Rules/Skills/Religion]] in a monastery to study old texts—but giving sermons at a church would still fall under [[Rules/Skills/Performance]] instead of Religion. You also might be able to use physical skills to make money, such as using [[Rules/Skills/Acrobatics]] to perform feats in a circus or Thievery to pick pockets. If you're using a skill other than [[Rules/Sidebars/Crafting Example|Crafting]], [[Rules/Sidebars/Common Lore Subcategories|Lore]], or Performance, the DC tends to be significantly higher.

[Earn Income Calculator](https://2e.aonprd.com/earn-income-calculator)

## Skill Uses

[[Rules/Skills/Crafting (Player Core)|[Crafting]]] Earn Income by crafting goods for the market.

[[Rules/Sidebars/Common Lore Subcategories (Player Core)|[Lore]]] Earn Income by using your knowledge to practice a trade.

[[Rules/Skills/Performance (Player Core)|[Performance]]] Earn Income by staging a performance.
...
Source on Archives of Nethys: [Earn Income](https://2e.aonprd.com/Skills.aspx?ID=21&General=true)
