...
type: "rules"
aon_id: "rules-1458"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=1458"
tags:
  - pf2e/rules
  - rarity/common
breadcrumbs:
...
next_link:
  - "label Infernal Contracts"
  - "url /Rules.aspx?ID=1460"
previous_link:
  - "label Casino Games"
  - "url /Rules.aspx?ID=1452"
...
**Source** [[Sources/Ancestry Guide]] pg. 66
...
**Tiny PCs**: PCs are typically Small or Medium size, but some ancestries, such as most sprites, are Tiny instead! Being Tiny comes with its own set of rules about space and reach. A Tiny PC can enter another creature's space, which is important because their melee Strikes typically have no reach, meaning the PC must enter a creature's space to attack it. Like other Tiny creatures, the PC doesn't automatically receive lesser cover from being in a larger creature's space, but circumstances might allow them to [[Actions/Take Cover]] in this instance. They can purchase weapons, armor, and other items for their size with the same statistics as normal gear, except that melee weapons have a reach of 0 for them (or a reach 5 feet shorter than normal if they have the [[Traits/Reach|reach]] trait). Remember to adjust the Bulk of items and the PC's Bulk limit for Tiny size (See [[Rules/Items and Sizes]]).

---

Source on Archives of Nethys: [Special Rules](https://2e.aonprd.com/Rules.aspx?ID=1458)
