...
type: "rules"
aon_id: "rules-2359"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=2359"
tags:
  - pf2e/rules
  - rarity/common
breadcrumbs:
...
next_link:
  - "label Moving Through a Creature’s Space"
  - "url /Rules.aspx?ID=2360"
previous_link:
  - "label Grid Movement"
  - "url /Rules.aspx?ID=2356"
...
# Size, Space, and Reach  *Rules*

**Source** [[Sources/Player Core]] pg. 421

Creatures and objects of different sizes occupy different amounts of space. The sizes and the spaces they each take up on a grid are listed in the Size and Reach table (see below). The table also lists the typical reach for creatures of each size, for both tall creatures (most bipeds) and long creatures (most quadrupeds). See [[Rules/Range and Reach (Player Core)|here]] for more about reach.
...
Source on Archives of Nethys: [Size, Space, and Reach](https://2e.aonprd.com/Rules.aspx?ID=2359)
