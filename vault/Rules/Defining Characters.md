...
type: "rules"
aon_id: "rules-9"
aon_url: "https://2e.aonprd.com/Rules.aspx?ID=9"
tags:
  - pf2e/rules
  - rarity/common
breadcrumbs:
...
next_link:
  - "label Creating a Narrative"
  - "url /Rules.aspx?ID=10"
previous_link:
  - "label What is a Roleplaying Game?"
  - "url /Rules.aspx?ID=2"
...
**Source** [[Sources/Core Rulebook]] pg. 8
...
Source on Archives of Nethys: [Defining Characters](https://2e.aonprd.com/Rules.aspx?ID=9)
