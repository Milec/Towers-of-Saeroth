...
type: "spell"
aon_id: "spell-669"
aon_url: "https://2e.aonprd.com/Spells.aspx?ID=669"
tags:
  - pf2e/spell
  - rarity/common
  - trait/conjuration
...
# Aqueous Orb two actions  *Spell 3*

**Traits** [[Traits/Conjuration]], [[Traits/Water]]

**Source** [[Sources/Advanced Player's Guide]] pg. 214

**Traditions**
[[Magic/Traditions/Arcane]], [[Magic/Traditions/Arcane|Primal]]

**Deities**
[[Setting/Deities/Aegirran]], [[Setting/Deities/Gogunta (Divine Mysteries)|Gogunta]], [[Setting/Deities/Hanspur (Divine Mysteries)|Hanspur]], [[Setting/Deities/Hataam]], [[Setting/Deities/Lysianassa (Divine Mysteries)|Lysianassa]], [[Setting/Deities/Obari]], [[Setting/Deities/Ristrentho]], [[Setting/Deities/Waves of the Boundless Sea]]
...
A sphere of water 10 feet in diameter forms in an unoccupied space in range, either on the ground or on the surface of a liquid. When you Cast the Spell and each time you Sustain the Spell, you can roll the orb, moving it up to 10 feet along the ground or the surface of a liquid. You can gain this effect multiple times in the same round by Sustaining the Spell multiple times. The orb can move through the spaces of any creatures or obstacles that wouldn't stop the flow of water. It extinguishes non-magical fires it moves through of its size or smaller, and it attempts to [[Rules/Counteracting (Core Rulebook)|counteract]] any magical fires it moves through. If it fails to counteract a given fire, it can't counteract that fire for the duration of the spell.
 ...
 A creature that fails its save is pulled into the orb. It becomes [[Rules/Conditions/Grabbed|grabbed]], moves along with the orb, and must hold its breath or begin [[Rules/Drowning and Suffocation|suffocating]] (unless it can breathe in water). An engulfed Medium or smaller creature and anyone trying to affect that creature follow the normal rules for [[Rules/Aquatic Combat|aquatic battles]]. An engulfed Large creature is usually big enough that parts of it stick out from the water, and it can reach out of the water. An engulfed creature can get free either by [[Actions/Swim|Swimming]] with a successful DC 10 [[Rules/Sidebars/Falling|Athletics]] check or by [[Actions/Escape|Escaping]] against your spell DC. A creature that critically failed its Reflex save is further stuck and must attempt to Escape instead of Swim. A freed creature exits the orb's space and can immediately breathe. The orb can contain as many creatures as can fit in its space.

 When the spell ends, all creatures the orb has engulfed are automatically released.

---

Source on Archives of Nethys: [Aqueous Orb](https://2e.aonprd.com/Spells.aspx?ID=669)
