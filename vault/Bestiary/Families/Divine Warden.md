...
aon_id: "creature-family-279"
aon_url: "https://2e.aonprd.com/MonsterFamilies.aspx?ID=279"
tags:
...
**Source** [[Sources/Bestiary 3]] pg. 72

Created through complex rituals performed by a faith's adherents, divine wardens have been imbued with a fraction of the power that courses through a [[Classes/Class Features/Ancestry and Background (class-feature-80)|champion]] or [[Classes/Class Features/Ancestry and Background (class-feature-111)|cleric]] of a particular deity. This divine spark allows the divine warden to serve as the protector for a temple, shrine, or other holy site. Such guardians aren't intrinsically bound to a fixed location, but they rarely leave the temple or site over which they watch.
...
[[Bestiary/Divine Warden Of Arazni]] (Creature 16), [[Bestiary/Divine Warden Of Brigh]] (Creature 10), [[Bestiary/Divine Warden Of Haagenti]] (Creature 4), [[Bestiary/Divine Warden Of Iomedae]] (Creature 16), [[Bestiary/Divine Warden Of Nethys]] (Creature 5)
...
- It gains the [[Traits/Uncommon|uncommon]] and [[Traits/Divine|divine]] traits. Its alignment changes to match that of its patron deity. For example, a divine warden of a lawful good deity becomes a lawful good creature.
 ...
 **Divine Destruction** ([[Traits/Divine|divine]], [[Traits/Necromancy|necromancy]]) When the divine warden is reduced to 0 HP, it erupts with divine energy in a 30-foot emanation, dealing 1d6 damage per level. This damage is either positive or negative, determined by the patron deity's divine font (chosen at the divine warden's creation if the deity offers a choice), and this ability gains the corresponding trait. Each creature in the area must attempt a Will save with the following outcomes.  
**Critical Success** The creature takes half damage.  
**Success** The creature takes full damage.  
**Failure** The creature takes full damage and becomes temporarily cursed by the patron deity. The creature becomes [[Rules/Conditions/Enfeebled|enfeebled 1]] and [[Rules/Conditions/Stupefied|stupefied 1]] for 1 day; this is a [[Traits/Curse|curse]] effect that uses the Will save DC as the [[Rules/Counteracting (Core Rulebook)|counteract]] DC.  
**Critical Failure** As failure, except the creature becomes enfeebled 2 and stupefied 2.

**Divine Innate Spells** A divine warden whose patron deity has any alignment components gains [[Spells/Divine Lance|_divine lance_]] as an innate cantrip. A divine warden with a neutral patron deity instead gains [[Spells/Daze|_daze_]] as an innate cantrip.

**Divine Domain Spells** The divine warden selects two of its patron deity's domains. The divine warden can cast the basic domain spell for its chosen domains. The divine warden has a focus pool of 1 Focus Point. It can't [[Actions/Refocus]], but its focus pool automatically refills 24 hours after it last used a Focus Point. If the divine warden is at least 10th level, it also gains the advanced domain spells for its chosen domains, and its focus pool increases to 2 Focus Points.

**Faith Bound** ([[Traits/Abjuration|abjuration]], [[Traits/Divine|divine]]) A divine warden can't attack a creature that openly wears or displays the religious symbol of the divine warden's patron deity unless that creature uses a hostile action against the divine warden first. If the divine warden is intelligent, it can also attack a creature it believes isn't faithful to its deity or who wears the religious symbol as a ruse (typically after succeeding at a Perception check to [[Actions/Sense Motive]]).

**Faithful Weapon** A divine warden always wields its patron deity's favored weapon. If the weapon is a ranged weapon, the divine warden automatically generates new ammunition with each attack. For a divine warden of 4th level or higher, the deity's favored weapon gains the effects of a [[Equipment/Striking|_striking_]] rune while the divine warden wields it; at 12th level, these effects are of a _greater striking_ rune, and at 19th level, they're instead of a _major striking_ rune.

**Instrument of Faith** The divine warden is a beacon for its deity's faith. A [[Classes/Class Features/Ancestry and Background (class-feature-111)|cleric]] of the divine warden's patron deity can channel a [[Spells/Heal|_heal_]] spell through a divine warden they can see within 60 feet. The cleric determines any targets or area for the spell as if they were standing in the divine warden's space.

---

Source on Archives of Nethys: [Divine Warden](https://2e.aonprd.com/MonsterFamilies.aspx?ID=279)
