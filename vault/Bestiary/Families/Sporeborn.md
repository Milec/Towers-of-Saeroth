...
aon_id: "creature-family-340"
aon_url: "https://2e.aonprd.com/MonsterFamilies.aspx?ID=340"
tags:
  - pf2e/creature-family
  - rarity/common
creature_family: "Sporeborn"
is_standard_ancestry_feat: false
primary_source: "Pathfinder #193: Mantle of Gold"
primary_source_category: "Adventure Paths"
primary_source_group: "Sky King's Tomb"
rarity: "common"
...
# Sporeborn  *Creature Family*

**Source** [[Sources/Pathfinder -193- Mantle of Gold|Pathfinder #193: Mantle of Gold]] pg. 88
...
[[Bestiary/Sporeborn Myceloid]] (Creature 4)
...
>
>
> To create a mycoguardian, such as a sporeborn, a ritualist can perform a ritual similar to [[Rituals/Create Undead|_create undead_]] called _create mycoguardian_, but providing valuable parasitic fungal spores instead of black onyx. This ritual uses Fungus Lore (trained) or Nature (expert) for both the Primary Check and Secondary Checks, and lacks the Evil trait.
 ...
 **Consume Biomatter** ([[Traits/Manipulate|manipulate]]) If the sporeborn is adjacent to a helpless or unconscious creature, or a deceased creature who died in the past hour, the sporeborn can consume its flesh with mycelium tendrils to heal itself. This restores an amount of Hit Points equal to the sporeborn's level. If the creature is alive, the sporeborn deals damage equal to one of its unarmed attacks.  
 **Contagious Spores** ([[Traits/Disease|disease]], [[Traits/Fungus|fungus]]) The sporeborn continues to infect creatures with sporeborn infestation, creating more of its own kind.  
 **Sporeborn Infestation** ([[Traits/Disease|disease]], [[Traits/Fungus|fungus]]); An infected creature can't heal damage it takes from sporeborn infestation until it has been cured of the disease.  
 **Saving Throw** Use a Fortitude save for the creature's level using the [[Rules/Level-Based DCs|DCs by Level table]].  
 ...
 **Fungal Armor** ([[Traits/Fungus|fungus]]) The sporeborn grows broad patches of dense fungus on the outside of the corpse. It gains resistance to bludgeoning damage equal to its level. Potent Poison ([[Traits/Fungus|fungus]], [[Traits/Poison|poison]]) The sporeborn fungus enhances the dead creature's natural toxins rather than diminishing them. Increase the DC of poison and spore abilities of the base creature by 2 rather than decreasing them.  
 **Rancid Spore Pods** ([[Traits/Disease|disease]], [[Traits/Fungus|fungus]]) The sporeborn is covered in spore pods that rupture when it takes any piercing damage or a critical hit. In either case, adjacent creatures are hit with spores, causing them to become [[Rules/Conditions/Sickened|sickened]] 1 unless they succeed at a Fortitude save.  
 **Spore Explosion** ([[Traits/Fungus|fungus]], [[Traits/Inhaled|inhaled]]) When the sporeborn is destroyed, its body explodes, releasing toxic fumes and spores. Adjacent creatures take 1d6 poison damage per 2 levels (minimum 1d6) with a basic Fortitude save.

---

Source on Archives of Nethys: [Sporeborn](https://2e.aonprd.com/MonsterFamilies.aspx?ID=340)
