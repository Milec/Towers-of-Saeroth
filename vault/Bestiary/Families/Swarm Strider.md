...
**Source** [[Sources/Monster Core 2]] pg. 310
...
## Swarm Strider Abilities
 ...
 A swarm strider gains the [[Traits/Aberration (Player Core)|aberration]] and [[Traits/Swarm (GM Core)|swarm]] traits. They lose any traits that represent their former life, such as [[Traits/Human (Player Core)|human]] and [[Traits/Humanoid (Player Core)|humanoid]], though they usually remain the same size, keep the same items, and use the same weapons as they did before their rebirth. Swarm striders typically have the following abilities.

 **[[Bestiary/Abilities/Darkvision (Monster Core)|Darkvision]]**

 **[[Bestiary/Abilities/Tremorsense (Monster Core)|Tremorsense]]** 30 feet ([[Rules/Imprecise Senses|imprecise]])

 **[[Bestiary/Abilities/All-Around Vision (Monster Core)|All-around Vision]]**

 **Clinging Remnants** A swarm strider's melee Strikes and ranged Strikes made against targets within their weapon's first range increment deposit biting vermin on the target, dealing 1d4 [[Rules/Sidebars/Persistent Damage Rules|persistent piercing damage]], increasing to 2d4 at 5th level, 3d4 at 10th level, 4d4 at 15th level, and 5d4 at 20th level.
 ...
 **Immunities** precision, [[Bestiary/Abilities/Swarm Mind (Monster Core)|swarm mind]] **Resistances** resistance 2 to physical and [[Traits/Poison (Player Core)|poison]], increasing to 5 at 5th level, 10 at 10th level, 15 at 15th level, and 20 at 20th level.

 **Weaknesses** weakness 2 to area damage and [[Traits/Splash (GM Core)|splash]] damage, increasing to 5 at 5th level, 10 at 10th level, 15 at 15th level, and 20 at 20th level

 **Draw Bugs** single action ([[Traits/Healing (Player Core)|healing]]) The swarm strider draws more arthropods from the environment around them to reconstitute some of their damaged body. They regain the listed number of HP, which is typically 5 HP, increasing to 10 at 5th level, 15 at 10th level, and 20 at 15th level. At the GM's discretion, the swarm strider doesn't recover HP in areas where there aren't enough arthropods to call to themselves.

 **Squirming Embrace** single action The swarm strider Strides. If they end their movement sharing a space with a creature, they deal 1d6 piercing damage to the creature, with a [[Rules/Basic Saving Throws (Core Rulebook)|basic]] Reflex save. The save DC is the high spell DC for the [[Rules/Level-Based DCs (GM Core)|swarm strider's level]]. The damage increases by 1d6 at 4th level and every 3 levels thereafter. The swarm strider can [[Actions/Burrow (Player Core)|Burrow]], [[Actions/Climb (Player Core)|Climb]], [[Actions/Fly (Player Core)|Fly]], or [[Actions/Swim (Player Core)|Swim]] instead of Striding if they have the corresponding movement type.

 **Swarm Shape** single action ([[Traits/Concentrate (Player Core)|concentrate]]) The swarm strider collapses into a shapeless swarm of their constituent creatures. They drops all items in their possession. In this form, the swarm strider can't use [[Traits/Attack (Player Core)|attack]] actions and can't cast spells, but they can move through areas small enough for their constituent creatures to fit without having to [[Actions/Squeeze (Player Core)|Squeeze]]. They can use the same action to coalesce from their swarm shape back into their normal form.

## Members

[[Bestiary/Skittering Slayer]] (Creature 8), [[Bestiary/Thousand Thieves]] (Creature 16), [[Bestiary/Worm Prophet (Monster Core 2)|Worm Prophet]] (Creature 12)
...
>
> **Cicada:** These noisome swarm striders often hibernate for years at a time, and their screeching is known to [[Rules/Counteracting (rules-3280)|counteract]] [[Traits/Auditory (Player Core)|auditory]] effects.
>
> **Lamprey:** A [[Bestiary/Kraken (Monster Core)|kraken’s]] corpse or awakened whalefall can seep intelligence into the lampreys that feast on their flesh, creating aquatic swarm striders with prodigious size and reach.
>
> **Leech:** This bloodsucking swarm strider usually forms from a fresh corpse exsanguinated in a leechinfested swamp, gaining both the ability to swim and to deal [[Rules/Sidebars/Persistent Damage Rules (Player Core)|persistent bleed damage]] instead of piercing damage.
>
> **Wasp:** Stinging and buzzing, a wasp strider flies, moving much faster in the air than on the ground.

---

Source on Archives of Nethys: [Swarm Strider](https://2e.aonprd.com/MonsterFamilies.aspx?ID=624)
