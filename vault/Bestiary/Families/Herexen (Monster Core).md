...
**Source** [[Sources/Monster Core]] pg. 195
...
[[Bestiary/Herexen (Monster Core)|Herexen]] (Creature 2)
...
- Swap the defiled religious symbol for the correct deity. For example, an ex-[[Setting/Deities/Sarenrae (Divine Mysteries)|Sarenite]] herexen carries a [[Equipment/Weapons/Scimitar (Player Core)|scimitar]] and a defiled religious symbol of Sarenrae, and can cast [[Spells/Fire Ray (Player Core)|_fire ray_]] (attack +12) as a focus spell.

## Greater Herexens

 More powerful clerics, or herexens that have existed over long spans of time, might become a more powerful 8th-level variant known as a greater herexen. In addition to the typical increases to its statistics, it casts [[Spells/Harm (Player Core)|_harm_]] as a 4th-rank spell, gains a second Focus Point and a 4th-rank domain spell, and deals 2d6 spirit damage with heretic's smite instead of 1d6.

---

Source on Archives of Nethys: [Herexen](https://2e.aonprd.com/MonsterFamilies.aspx?ID=428)
