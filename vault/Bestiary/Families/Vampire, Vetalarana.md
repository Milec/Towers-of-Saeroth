---
title: "Vampire, Vetalarana"
type: "creature-family"
aon_id: "creature-family-311"
aon_url: "https://2e.aonprd.com/MonsterFamilies.aspx?ID=311"
tags:
...
# Vampire, Vetalarana  *Creature Family*

**Source** [[Sources/Book of the Dead]] pg. 160

Vetalarana vampires feed on the emotions, thoughts, and memories of others. Although they are capable of feeding on animals, beings of the planes, and other intelligent [[Traits/Undead|undead]], only the thoughts of an intelligent, living [[Traits/Humanoid|humanoid]] bring a vetalarana any sense of satisfaction. Slender and pale, with sunken cheeks and exceptionally long nails, vetalaranas become flushed with color and life after feeding on particularly potent emotions and thoughts, enabling some to pass as living for a short time.
...
[[Bestiary/Vetalarana Emergent]] (Creature 8), [[Bestiary/Vetalarana Manipulator]] (Creature 11)
...
>
>
> Canny mortals looking to thwart a vetalarana make heavy use of [[Equipment/Cold Iron|cold iron]]. They line their sanctuaries with the material or surround comatose victims in cold iron sheets, armor, or shields. Others weave shrouds of cold iron thread or mix cold iron dust into paints and oils—though the efficacy of the latter is debatable.

## Vampire  *Creature Family Group*

**Related Families**
[[Bestiary/Families/Vampire]], [[Bestiary/Families/Vampire, Jiang-Shi]], [[Bestiary/Families/Vampire, Nosferatu]], [[Bestiary/Families/Vampire, Nosferatu (Monster Core 2)|Vampire, Nosferatu]], [[Bestiary/Families/Vampire, Strigoi]], [[Bestiary/Families/Vampire, Vrykolakas]]
...
- It gains the [[Traits/Undead|undead]] and [[Bestiary/Families/Vampire|vampire]] traits, and usually becomes evil.
...
- The vetalarana gains fast healing, resistance to mental damage, and resistance to physical damage (except [[Equipment/Cold Iron Weapon|cold iron]]) as indicated on the table. These abilities are the reason the vetalarana has less HP.

## Vetalarana Statistics

| **Starting Level** | **Starting Level** | **Starting Level** |
| --- | --- | --- |
| 3-4 | –20 | 5 |
| 5-7 | –30 | 7 |
| 8-14 | –40 | 10 |
...
### Basic Vetalarana Abilities
 ...
 All vetalaranas gain the following abilities. If the base creature has any abilities that specifically come from being a living creature, it loses them. It also loses any traits that represented its life as a living creature, such as [[Traits/Human|human]] and [[Traits/Humanoid|humanoid]]. You might also need to adjust abilities that conflict with the vetalarana's theme.

 **Thoughtsense** ([[Traits/Divination|divination]], [[Traits/Mental|mental]], [[Traits/Occult|occult]]) The vetalarana senses all non-[[Traits/Mindless|mindless]] creatures within 100 feet as a precise sense.

 **Negative Healing**

 **Immunities** [[Traits/Death|death]] effects, [[Traits/Disease|disease]], paralyzed, [[Traits/Poison|poison]], [[Traits/Sleep|sleep]]

 **Vetalarana Vulnerabilities** All vetalaranas possess the following weaknesses.

- **Barred Senses** A vetalarana can't see or sense through [[Traits/Force|force]] effects or [[Equipment/Cold Iron Weapon|cold iron]], and their mind can't penetrate force effects or cold iron. Such barriers can prevent the transference of a vetalarana's mind through Mental Rebirth.
- **Revulsion** A vetalarana delights in consuming memories and secrets, and is disgusted by those who share such sensitive tidbits openly. A vetalarana can't voluntarily come within 10 feet of a creature loudly voicing their intimate personal secrets or most cherished memories aloud. Speaking such information aloud with conviction is a single action that has the [[Traits/Auditory|auditory]], [[Traits/Concentrate|concentrate]], and [[Traits/Linguistic|linguistic]] traits, and protects the creature until the start of its next turn. A vetalarana that involuntarily comes within 10 feet of a creature sharing such information gains the fleeing condition until they're 10 feet or farther from the creature. After 1 round of being exposed to the secrets of a creature, a vetalarana can attempt a DC 25 Will save as a single action, which has the concentrate trait. On a success, they overcome their revulsions for 1d6 rounds (or 1 hour on a critical success).
- **Vulnerable to Brain Destruction** A vetalarana whose brain has been destroyed, or is reduced to 0 HP while unable to take [[Traits/Mental|mental]] actions, can't use Mental Rebirth.

 **Mental Rebirth** ([[Traits/Curse|curse]], [[Traits/Incapacitation|incapacitation]], [[Traits/Mental|mental]], [[Traits/Necromancy|necromancy]], [[Traits/Occult|occult]]) Unlike most other undead, a vetalarana isn't destroyed when they reach 0 HP. Instead, their body is destroyed, crumbling to ash, and their mind is immediately transferred into a creature they rendered comatose through Drain Thoughts. This creature must be within 1 mile; if no such creature is in range, the vetalarana is destroyed. The creature becomes [[Rules/Conditions/Controlled|controlled]] by the vetalarana and loses the [[Rules/Conditions/Stupefied|stupefied]] and [[Rules/Conditions/Unconscious|unconscious]] conditions. If the creature controlled by a vetalarana in this way is killed, the vetalarana's mind transfers to another creature within 1 mile who they rendered comatose through Drain Thoughts.  
 ...
 **Resistances** The vetalarana manipulator resists [[Traits/Mental|mental]] damage and all physical damage (except [[Traits/Magical|magical]] [[Equipment/Cold Iron Weapon|cold iron]]).

 **Control Comatose** ([[Traits/Exploration|exploration]], [[Traits/Incapacitation|incapacitation]], [[Traits/Mental|mental]], [[Traits/Necromancy|necromancy]], [[Traits/Occult|occult]], [[Traits/Possession|possession]]) **Frequency** once per day; **Effect** The vetalarana manipulator spends 10 minutes to take psychic control of the creatures they've rendered comatose with Drain Thoughts. This has the effects of the [[Spells/Possession|_possession_]] spell, but lasts for up to 6 hours, has a range of 1 mile, and the vetalarana can control a number of comatose victims at a time equal to half the vetalarana's level. A comatose victim can't resist this possession and automatically gets a critical failure on its saving throw against Control Comatose.  
 ...
 **Drain Thoughts** single action ([[Traits/Divination|divination]], [[Traits/Mental|mental]], [[Traits/Occult|occult]]) As a basic vetalarana, but the vetalarana manipulator can choose to alter, enhance, or erase the memory they view as a 4th-level [[Spells/Modify Memory|_modify memory_]] spell. If the vetalarana gets a critical success on their Athletics check to Drain Thoughts, the target is stupefied 2 instead of stupefied 1.

 **Occult Innate Spells** A vetalarana manipulator has [[Spells/Tongues|_tongues_]] as a constant occult innate spell.

 **Paralyzing Claws** ([[Traits/Incapacitation|incapacitation]], [[Traits/Occult|occult]], [[Traits/Necromancy|necromancy]]) Any living creature hit by a vetalarana manipulator's claw Strike must succeed at a Fortitude save or become [[Rules/Conditions/Paralyzed|paralyzed]]. The target can attempt a new save at the end of each of its turns to end the effect, and the DC cumulatively decreases by 1 on each such save. Use the moderate DC for the creature's level on the [[Rules/Spell DC and Spell Attack Roll|Spell DC and Spell Attack Bonus]] table.

---

Source on Archives of Nethys: [Vampire, Vetalarana](https://2e.aonprd.com/MonsterFamilies.aspx?ID=311)
