...
([[Rules/Skills/Society (Player Core)|Society]]): DC 23

**[[Rules/Recall Knowledge|Unspecific Lore]]**: DC 21

**[[Rules/Recall Knowledge|Specific Lore]]**: DC 18

## Medusa  *Creature 7*

**Traits** Medium, [[Traits/Humanoid (Player Core)|Humanoid]]

**Source** [[Sources/Monster Core]] pg. 230
...
**Skills**
[[Rules/Skills/Deception]] +16, [[Rules/Sidebars/Changing Attitudes|Diplomacy]] +14, [[Rules/Sidebars/Being Stealthy|Stealth]] +16
...
**Items**
_+1 [[Equipment/Weapons/Composite Shortbow (Player Core)|composite shortbow]]_ (60 arrows), [[Equipment/Weapons/Shortsword]]

---

**AC** 25 [[Bestiary/Abilities/All-Around Vision (Monster Core)|all-around vision]]
...
**Petrifying Gaze** ([[Traits/Arcane (Player Core)|arcane]], [[Traits/Aura (Player Core)|aura]], [[Traits/Visual (Player Core)|visual]]) 30 feet. When a creature ends its turn in the aura, it must attempt a DC 25 Fortitude save. If the creature fails, it becomes [[Rules/Conditions/Slowed (Player Core)|slowed 1]] for 1 minute. The medusa can deactivate or activate this aura by using a single action, which has the [[Traits/Concentrate (Player Core)|concentrate]] trait.  
...
**Melee**
single action
shortsword +18 ([[Traits/Agile (Player Core)|Agile]], [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Versatile (Player Core)|versatile S]]),
**Damage** 1d6+8 piercing plus serpent venom

**Melee**
single action
snake fangs +16 ([[Traits/Agile (Player Core)|Agile]], [[Traits/Finesse (Player Core)|Finesse]]),
**Damage** 1d4+8 piercing plus serpent venom

**Ranged**
single action
_composite shortbow_ +19 ([[Traits/Deadly (Player Core)|deadly d10]], [[Traits/Magical (Player Core)|Magical]], [[Traits/Propulsive (Player Core)|Propulsive]], [[Traits/Range|range increment 60 feet]], [[Traits/Reload|reload 0]]),
**Damage** 1d6+7 piercing plus serpent venom

**Focus Gaze** single action ([[Traits/Arcane (Player Core)|Arcane]], [[Traits/Concentrate (Player Core)|Concentrate]], [[Traits/Incapacitation (Player Core)|Incapacitation]], [[Traits/Visual (Player Core)|Visual]]) The medusa fixes their glare at a creature they can see within 30 feet. The target must immediately attempt a Fortitude save against the medusa's petrifying gaze. If the creature was already slowed by petrifying gaze before attempting its save, a failed save causes it to be [[Rules/Conditions/Petrified (Player Core)|petrified]] permanently. After attempting its save, the creature is then temporarily immune until the start of the medusa's next turn.

**Serpent Venom**  ([[Traits/Poison (Player Core)|Poison]]) **Saving Throw** DC 25 Fortitude; **Maximum Duration** 6 rounds; **Stage 1** 1d6 poison damage and [[Rules/Conditions/Enfeebled (Player Core)|enfeebled 1]] (1 round); **Stage 2** 2d6 poison damage and enfeebled 2 (1 round)
...
Source on Archives of Nethys: [Medusa](https://2e.aonprd.com/Monsters.aspx?ID=3096)
