...
aon_id: "creature-adjustment-14"
aon_url: "https://2e.aonprd.com/MonsterTemplates.aspx?ID=14"
tags:
...
**Source** [[Sources/Dark Archive]] pg. 60
...
- Increase the creature's rarity to [[Traits/Uncommon|uncommon]] if it was common or [[Traits/Rare|rare]] if it was uncommon. If the creature was an animal, it loses the [[Traits/Animal|animal]] trait and gains the [[Traits/Beast|beast]] trait.
 ...
 **Stench** ([[Bestiary/Abilities/Aura|aura]], [[Traits/Olfactory|olfactory]]) 30 feet. A creature entering the emanation or starting its turn in the emanation must succeed at a Fortitude save against the [[Rules/Difficulty Classes|standard DC for the creature's level]] or become [[Rules/Conditions/Sickened|sickened 1]] (plus [[Rules/Conditions/Slowed|slowed 1]] as long as it's sickened on a critical failure). While within the emanation, affected creatures take a –2 circumstance penalty to saves against [[Traits/Disease|diseases]] and to recover from the sickened condition. A creature that succeeds at its save is temporarily immune for 1 minute.
