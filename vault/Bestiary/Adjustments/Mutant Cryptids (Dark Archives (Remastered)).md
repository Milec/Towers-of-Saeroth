...
**Source** [[Sources/Dark Archives (Remastered)]] pg. 59
...
- Add the [[Traits/Rare (Player Core)|rare]] trait.
- Increase the creature's AC, attack bonuses, DCs, Perception modifier, saving throws, and skill modifiers by 1.
- Increase the damage of its Strikes and other offensive abilities by 1. If an ability can be used only a small number of times (such as a dragon's breath), increase the damage by 2 instead.
