...
title: "Skull Peeler"
type: "creature"
aon_id: "creature-1306"
aon_url: "https://2e.aonprd.com/Monsters.aspx?ID=1306"
tags:
  - pf2e/creature
  - rarity/common
  - trait/beast
...
**Snatch Skull** ⤾ **Trigger** The skull peeler is using Perfect Camouflage and a creature moves into a space within 15 feet of it; **Effect** The skull peeler [[Actions/Leap|Leaps]] toward the triggering creature and Strikes with its tongue. If this Strike is successful, the skull peeler automatically [[Bestiary/Abilities/Grab|Grabs]] the target with its tongue.
...
**Melee**
single action
tongue +17 ([[Traits/Agile]], [[Traits/Fatal|fatal d12]], [[Traits/Reach|reach 10 feet]]),
**Damage** 2d4+8 slashing plus 1d8 [[Rules/Sidebars/Persistent Damage Rules|persistent bleed]]
...
**Anticoagulant**   The skull peeler's razor-sharp tongue is coated in an anticoagulant substance that makes wounds it inflicts particularly hard to close. The DC of the flat check to end the [[Rules/Sidebars/Persistent Damage Rules|persistent bleed damage]] from a skull peeler's tongue is 16, or 11 with appropriate assistance.

**Perfect Camouflage** single action ([[Traits/Concentrate]]) **Requirements** The skull peeler is in a treetop or standing on a tree limb; **Effect** Until the next time it acts, the skull peeler hangs perfectly still, blending into the treetop surroundings. It has an automatic result of 36 on [[Rules/Sidebars/Being Stealthy|Stealth]] checks and DCs to [[Actions/Hide]] from any creature more than 10 feet away from it.
