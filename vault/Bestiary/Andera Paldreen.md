...
type: "creature"
aon_id: "creature-2024"
aon_url: "https://2e.aonprd.com/NPCs.aspx?ID=2024"
tags:
  - pf2e/creature
  - rarity/unique
  - trait/human
...
item:
  - "Breastplate"
  - "chief constable's badge (as diplomat's badge )"
  - "+1 striking falchion"
language:
  - "Common"
  - "Elven"
...
npc: true
perception: 21
primary_source: "Pathfinder #152: Legacy of the Lost God"
...
([[Rules/Sidebars/Examining Forgeries|Society]]): DC 37

**[[Rules/Recall Knowledge|Unspecific Lore]]**: DC 35

**[[Rules/Recall Knowledge|Specific Lore]]**: DC 32

## Andera Paldreen  *Creature 10*

**Traits** [[Traits/Unique]], [[Rules/Alignment (Core Rulebook)|LN]], Medium, [[Traits/Human]], [[Traits/Humanoid]]

**Source** [[Sources/Pathfinder -152- Legacy of the Lost God|Pathfinder #152: Legacy of the Lost God]] pg. 88

**Perception** +21

**Languages**
[[Setting/Languages/Common]], [[Setting/Languages/Elven]], [[Setting/Languages/Halfling]]

**Skills**
[[Rules/Sidebars/Falling|Athletics]] +19, [[Rules/Sidebars/Common Lore Subcategories|Criminal Lore]] +19, [[Rules/Sidebars/Changing Attitudes|Diplomacy]] +22, [[Rules/Skills/Intimidation]] +21, [[Rules/Sidebars/Examining Forgeries|Society]] +19, [[Rules/Skills/Survival]] +17, [[Rules/Sidebars/Common Lore Subcategories|Underworld Lore]] +19
...
**Items**
[[Equipment/Armor/Breastplate]], chief constable's badge (as [[Equipment/Diplomat's Badge|_diplomat's badge_]]), _+1 [[Equipment/Striking|striking]] [[Equipment/Weapons/Falchion|falchion]]_
...
**[[Bestiary/Abilities/Attack of Opportunity]]** ⤾ Andera can use Attack of Opportunity when a creature within her reach uses a [[Traits/Concentrate|concentrate]] action, in addition to its normal trigger. If her attack hits, and the trigger was a concentrate or [[Traits/Manipulate|manipulate]] action, she disrupts that action (rather than disruption on only a critical hit).
...
**Melee**
single action
_falchion_ +22 ([[Traits/Forceful]], [[Traits/Sweep]]),
**Damage** 2d10+7 slashing

**Call to Halt** two actions ([[Traits/Auditory]], [[Traits/Concentrate]], [[Traits/Emotion]], [[Traits/Mental]]) Andera makes an **Intimidation** check and compares it to the Will DC of each creature she chooses within 30 feet. Regardless of her result, the targets are temporarily immune for 10 minutes.  
**Critical Success** The target is [[Rules/Conditions/Paralyzed|paralyzed]] for 1 minute and becomes [[Rules/Conditions/Frightened|frightened 2]].  
**Success** The target takes a –10-foot penalty to all its Speeds for 1 minute and becomes frightened 1.

**Shrewd Eye**   Andera treats all Perception checks made to [[Actions/Sense Motive]] as one degree of success better than the result of her check.

---

Source on Archives of Nethys: [Andera Paldreen](https://2e.aonprd.com/NPCs.aspx?ID=2024)
