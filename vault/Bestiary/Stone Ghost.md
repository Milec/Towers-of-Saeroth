...
title: "Stone Ghost"
type: "creature"
aon_id: "creature-1618"
aon_url: "https://2e.aonprd.com/Monsters.aspx?ID=1618"
tags:
  - pf2e/creature
  - rarity/unique
  - trait/human
...
npc: false
perception: 13
primary_source: "Pathfinder #169: Kindled Magic"
...
**Traits** [[Traits/Unique]], [[Rules/Alignment (Core Rulebook)|NE]], Medium, [[Traits/Human]], [[Traits/Humanoid]], [[Traits/Oread]]

**Source** [[Sources/Pathfinder -169- Kindled Magic|Pathfinder #169: Kindled Magic]] pg. 88

**Perception** +13

**Languages**
[[Setting/Languages/Common]], [[Setting/Languages/Gnoll]], [[Setting/Languages/Terran]]

**Skills**
[[Rules/Skills/Arcana]] +12, [[Rules/Sidebars/Falling|Athletics]] +12, [[Rules/Skills/Intimidation]] +12, [[Rules/Sidebars/Common Lore Subcategories|Magaambya Lore]] +12, [[Rules/Sidebars/Commanded Animals|Nature]] +13, [[Rules/Sidebars/Being Stealthy|Stealth]] +11
...
**Items**
[[Equipment/Armor/Leather Armor]], _+1 [[Equipment/Weapons/Morningstar|morningstar]]_, [[Equipment/Weapons/Sling]] (10 bullets)
...
**Resistances**
all damage 5 (except [[Traits/Force|force]] or [[Equipment/Ghost Touch|_ghost touch_]]

**Stone Spirit** Stone Ghost can pass through objects made of stone or soil, including walls. When inside an object, Stone Ghost can't perceive, attack, or interact with anything outside the object, and if he starts his turn inside an object, he is [[Rules/Conditions/Slowed|slowed 1]].
...
**Melee**
single action
_morningstar_ +15 ([[Traits/Magical]], [[Traits/Versatile|versatile P]]),
**Damage** 1d6+7 bludgeoning

**Ranged**
single action
sling +11 ([[Traits/Propulsive]], [[Traits/Range|range increment 50 feet]], [[Traits/Reload|reload 1]]),
**Damage** 1d6+5 bludgeoning

**Primal Prepared Spells** DC 22, attack +14
- **Cantrips (3rd)**
[[Spells/Acid Splash]], [[Spells/Dancing Lights]], [[Spells/Know Direction]], [[Spells/Shield]], [[Spells/Tanglefoot]]
- **1st**
[[Spells/Command]] (animals only), [[Spells/Grease]], [[Spells/Pass Without Trace]]
- **2nd**
[[Spells/Darkvision]], [[Spells/Glitterdust]], [[Spells/Shatter]]
- **3rd**
[[Spells/Earthbind]], [[Spells/Summon Elemental]] (earth only)

**Entombing Grasp** two actions ([[Traits/Earth]], [[Traits/Manipulate]]) **Requirements** A foe within Stone Ghost's reach is standing on stone or soil; **Effect** Stone Ghost briefly extends his intangibility to a foe and drags or pounds them into the earth. He makes an [[Rules/Sidebars/Falling|Athletics]] check against the target's Fortitude DC. On a success, the foe is planted waist-deep in the ground and is immobilized and flat-footed until it [[Actions/Escape|Escapes]] (DC 22). On a critical success, the foe is completely buried and must hold its breath until it is free or else start [[Rules/Drowning and Suffocation|suffocating]]. A successful Escape returns the foe to its original square on the surface, or the closest unoccupied square.

---

Source on Archives of Nethys: [Stone Ghost](https://2e.aonprd.com/Monsters.aspx?ID=1618)
