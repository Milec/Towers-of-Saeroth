...
title: "K'nonna"
type: "creature"
aon_id: "creature-1434"
aon_url: "https://2e.aonprd.com/Monsters.aspx?ID=1434"
tags:
  - pf2e/creature
  - rarity/common
  - trait/aberration
...
language:
  - "Mwangi"
  - "half, see Half Speaker"
level: 8
npc: false
perception: 16
pfs: "Standard"
primary_source: "The Mwangi Expanse"
...
**Traits** [[Rules/Alignment (Core Rulebook)|NE]], Medium, [[Traits/Aberration]]

**Source** [[Sources/The Mwangi Expanse]] pg. 299

**Perception** +16; [[Bestiary/Abilities/Darkvision|darkvision]], [[Bestiary/Abilities/Scent|scent]] (imprecise) 60 feet

**Languages**
[[Setting/Languages/Mwangi]]; half, see Half Speaker

**Skills**
[[Rules/Sidebars/Falling|Athletics]] +21, [[Rules/Sidebars/Being Stealthy|Stealth]] +16
...
**Gilded Fascination** When offered a gift worth at least 50 gp, the k'nonna must attempt a DC 20 Will saving throw; if the gift is worth at least 100 gp, the DC is instead 25. If they fail the save, the k'nonna accepts the gift, becomes [[Rules/Conditions/Fascinated|fascinated]] until the end of their next turn, and cannot attack while fascinated. On a critical failure, the fascination lasts for 1 minute. Offering a gift is an Interact action, and offering multiple gifts in the same round has no additional effect.  
**Half-Speaker** A k'nonna can communicate easily with other k'nonna, but when communicating with other creatures, only half of the spoken words make sense. In order to convey information to a k'nonna or understand what they're saying, a non-k'nonna must succeed at a DC 20 Perception check.  
...
**Melee**
single action
fist +20 ([[Traits/Agile]]),
**Damage** 2d10+8 bludgeoning

**Melee**
single action
jaws +20,
**Damage** 2d8+8 piercing plus [[Bestiary/Abilities/Grab]]

**Pounce** single action  The k'nonna Strides and makes a Strike at the end of that movement. If the k'nonna began this action [[Rules/Conditions/Hidden|hidden]], they remain hidden until after this ability's Strike.
...
Source on Archives of Nethys: [K'nonna](https://2e.aonprd.com/Monsters.aspx?ID=1434)
