...
([[Rules/Skills/Nature (Player Core)|Nature]]): DC 15
...
**Traits** Small, [[Traits/Animal (Player Core)|Animal]], [[Traits/Dinosaur (Player Core)|Dinosaur]]

**Source** [[Sources/Monster Core]] pg. 96

**Perception** +6; [[Bestiary/Abilities/Low-Light Vision (Monster Core)|low-light vision]], [[Bestiary/Abilities/Scent (Monster Core)|scent]] ([[Rules/Imprecise Senses|imprecise]]) 30 feet

**Languages**

**Skills**
[[Rules/Skills/Acrobatics]] +8, [[Rules/Sidebars/Falling|Athletics]] +5, [[Rules/Sidebars/Being Stealthy|Stealth]] +6
...
**Melee**
single action
jaws +8 ([[Traits/Finesse (Player Core)|Finesse]]),
**Damage** 1d6+3 piercing

**Melee**
single action
talon +8 ([[Traits/Agile (Player Core)|Agile]], [[Traits/Finesse (Player Core)|Finesse]]),
**Damage** 1d4+3 slashing

**Leaping Charge** single action  The velociraptor Strides up to 10 feet, ignoring [[Rules/Difficult Terrain|difficult terrain]] as it leaps over obstacles. It then makes a Strike with its talons, gaining a +1 circumstance bonus to its attack roll.
...
Source on Archives of Nethys: [Velociraptor](https://2e.aonprd.com/Monsters.aspx?ID=2915)
