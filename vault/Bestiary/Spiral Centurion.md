...
type: "creature"
aon_id: "creature-815"
aon_url: "https://2e.aonprd.com/Monsters.aspx?ID=815"
tags:
  - pf2e/creature
  - rarity/common
  - trait/construct
...
([[Rules/Skills/Arcana]], [[Rules/Sidebars/Crafting Example|Crafting]]): DC 28

**[[Rules/Recall Knowledge|Unspecific Lore]]**: DC 26

**[[Rules/Recall Knowledge|Specific Lore]]**: DC 23

## Spiral Centurion  *Creature 11*

**Traits** [[Rules/Alignment (Core Rulebook)|N]], Medium, [[Traits/Construct]], [[Traits/Mindless]]

**Source** [[Sources/Bestiary 2]] pg. 250

**Perception** +20; [[Bestiary/Abilities/Darkvision|darkvision]]

**Languages**

**Skills**
[[Rules/Skills/Acrobatics]] +23, [[Rules/Sidebars/Falling|Athletics]] +23
...
**Immunities**
bleed, [[Traits/Death|death]] effects, [[Traits/Disease|disease]], [[Rules/Conditions/Doomed|doomed]], [[Rules/Conditions/Drained|drained]], [[Rules/Conditions/Fatigued|fatigued]], [[Traits/Healing|healing]], [[Traits/Mental|mental]], [[Traits/Necromancy|necromancy]], nonlethal attacks, [[Rules/Conditions/Paralyzed|paralyzed]], [[Traits/Poison|poison]], [[Rules/Conditions/Sickened|sickened]], [[Rules/Conditions/Unconscious|unconscious]]

**Top-Heavy** A spiral centurion's top-like design makes it susceptible to effects that would cause it to fall prone. The DC of any attempt to knock the spiral centurion [[Rules/Conditions/Prone|prone]] is reduced by 5. If the spiral centurion attempts a check or saving throw to resist being knocked prone, it takes a -5 status penalty. A spiral centurion that has been knocked prone can't use any actions other than to attempt to Stand, but it must succeed at a DC 30 [[Rules/Skills/Acrobatics]] check to do so.
...
**Melee**
single action
blade +23 ([[Traits/Agile]], [[Traits/Sweep]]),
**Damage** 2d12+12 slashing

**Hurl Blade** two actions  The spiral centurion hurls one of its blades with an angled spin to ensure a swooping flight path. The blade deals 6d6 slashing damage to each creature in a 40-foot line (DC 30 [[Rules/Basic Saving Throws (Core Rulebook)|basic]] Reflex save). At the start of the spiral centurion's next turn, the blade swoops around and returns along the same flight path, again dealing 6d6 slashing damage (DC 30 basic Reflex save) to each creature along the same line.

**Rev Up** single action  **Requirements** The spiral centurion has not acted yet this turn; **Effect** The spiral centurion Strides up to its Speed. It then gains a +2 circumstance bonus to attack and damage rolls until the end of its turn.

**[[Bestiary/Abilities/Trample]]** three actions  Medium or smaller, blade, DC 30

**Whirling Death** three actions  The spiral centurion spins furiously in place, its blades extended to slice through nearby creatures. It makes up to five melee blade Strikes. No single creature can be targeted by more than one blade Strike during one use of this ability. These attacks count toward the spiral centurion's multiple attack penalty, but the multiple attack penalty doesn't increase until after all the attacks are made.
...
Source on Archives of Nethys: [Spiral Centurion](https://2e.aonprd.com/Monsters.aspx?ID=815)
