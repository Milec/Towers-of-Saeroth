...
type: "creature"
aon_id: "creature-378"
aon_url: "https://2e.aonprd.com/Monsters.aspx?ID=378"
tags:
  - pf2e/creature
  - rarity/common
  - trait/animal
...
**Source** [[Sources/Bestiary]] pg. 301

**Perception** +6; darkvision

**Languages**
[[Setting/Languages/Draconic]]; (can’t speak any language)

**Skills**
[[Rules/Skills/Acrobatics]] +6, [[Rules/Sidebars/Falling|Athletics]] +8, [[Rules/Sidebars/Being Stealthy|Stealth]] +5
...
**Melee**
single action
tusks +11 ([[Traits/Deadly|deadly 1d10]]),
**Damage** 1d8+4 piercing

**Ranged**
single action
slime squirt +9 ([[Traits/Range|range increment 30 feet]]),
**Damage** entangling slime

**Belly Grease** three actions  The slurk extrudes a slippery grease from its ventral glands to coat the floor under it and in a 5-foot emanation, turning the affected area into uneven ground for 10 minutes, after which it dries to a putrid crust. The DC to Balance across the slime is 18.
...
Source on Archives of Nethys: [Slurk](https://2e.aonprd.com/Monsters.aspx?ID=378)
