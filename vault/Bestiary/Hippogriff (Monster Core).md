...
**Source** [[Sources/Monster Core]] pg. 197

**Perception** +8; [[Bestiary/Abilities/Darkvision (Monster Core)|darkvision]], [[Bestiary/Abilities/Scent (Monster Core)|scent]] ([[Rules/Imprecise Senses|imprecise]]) 30 feet

**Languages**

**Skills**
[[Rules/Skills/Acrobatics]] +7, [[Rules/Sidebars/Falling|Athletics]] +7, [[Rules/Skills/Survival]] +6
...
**[[Bestiary/Abilities/Buck (Monster Core)|Buck]]** ⤾ DC 17
...
**Melee**
single action
talon +9 ([[Traits/Agile (Player Core)|Agile]]),
**Damage** 1d6+3 slashing

**Melee**
single action
wing +9 ([[Traits/Reach (Player Core)|reach 10 feet]]),
**Damage** 1d6+3 bludgeoning

**Flying Strafe** two actions  The hippogriff [[Actions/Fly (Player Core)|Flies]]up to its fly speed and makes two talon Strikes at any point during that movement. Each Strike must target a different creature. The attacks take the normal multiple attack penalty.

---

Source on Archives of Nethys: [Hippogriff](https://2e.aonprd.com/Monsters.aspx?ID=3052)
