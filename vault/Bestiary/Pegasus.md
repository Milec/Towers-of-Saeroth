...
type: "creature"
aon_id: "creature-329"
aon_url: "https://2e.aonprd.com/Monsters.aspx?ID=329"
tags:
  - pf2e/creature
  - rarity/common
  - trait/beast
...
([[Rules/Skills/Arcana]], [[Rules/Sidebars/Commanded Animals|Nature]]): DC 18
...
**Traits** [[Rules/Alignment (Core Rulebook)|NG]], Large, [[Traits/Beast]]

**Source** [[Sources/Bestiary]] pg. 260

**Perception** +12; darkvision, scent (imprecise) 30 feet

**Languages**
[[Setting/Languages/Common]]; (can’t speak any language)

**Skills**
[[Rules/Skills/Acrobatics]] +11, [[Rules/Sidebars/Falling|Athletics]] +10
...
**Melee**
single action
wing +10 ([[Traits/Agile]]),
**Damage** 1d6+5 bludgeoning

**Assisted Mount** single action  **Requirement** The pegasus is Flying without a rider. **Effect** The pegasus Flies. At any point during the movement, it can allow a willing adjacent creature to Mount it. That creature must use a reaction to do so.

**Gallop** two actions  The pegasus uses 2 move actions, each of which can be either Stride or Fly. It gains a +20-foot circumstance bonus to its Speeds during a Gallop.
...
Source on Archives of Nethys: [Pegasus](https://2e.aonprd.com/Monsters.aspx?ID=329)
