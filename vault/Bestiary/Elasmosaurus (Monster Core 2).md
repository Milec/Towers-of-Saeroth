...
([[Rules/Skills/Nature (Player Core)|Nature]]): DC 23

**[[Rules/Recall Knowledge|Unspecific Lore]]**: DC 21

**[[Rules/Recall Knowledge|Specific Lore]]**: DC 18

## Elasmosaurus  *Creature 7*

**Traits** Huge, [[Traits/Animal (Player Core)|Animal]]

**Source** [[Sources/Monster Core 2]] pg. 143

**Perception** +16; [[Bestiary/Abilities/Low-Light Vision (Monster Core)|low-light vision]], [[Bestiary/Abilities/Scent (Monster Core)|scent]] (imprecise) 30 feet
...
**Melee**
single action
jaws +16 ([[Traits/Reach (Player Core)|reach 15 feet]]),
**Damage** 2d12+10 piercing plus [[Bestiary/Abilities/Grab (Rage of Elements)|Grab]]
...
**Drag Below** single action ([[Traits/Attack (Player Core)|Attack]]) The elasmosaurus attempts an [[Rules/Sidebars/Multiple Attacks with Athletics (Player Core)|Athletics]] check against a [[Rules/Conditions/Grabbed (Player Core)|grabbed]] foe's Fortitude DC. If the elasmosaurus succeeds, the foe is forcibly moved 5 feet toward the elasmosaurus's body. If the elasmosaurus critically succeeds, the foe is moved 10 feet toward the elasmosaurus's body.

**Thrashing Retreat** two actions  A swimming elasmosaurus thrashes the area around it as it attempts to flee. It makes two paddle Strikes, each of which must be against separate targets, and each of which takes the normal multiple attack penalty. It then [[Actions/Swim (Player Core)|Swims]] up to its swim Speed. This Swim does not trigger reactions based on movement.
...
Source on Archives of Nethys: [Elasmosaurus](https://2e.aonprd.com/Monsters.aspx?ID=4377)
