...
type: "ancestry"
aon_id: "ancestry-19"
aon_url: "https://2e.aonprd.com/Ancestries.aspx?ID=19"
tags:
  - pf2e/ancestry
  - rarity/uncommon
  - trait/humanoid
...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=19"
  - "label Feats"
  - "url /Ancestries.aspx?ID=19/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=19/heritages"
...
**Traits** [[Traits/Uncommon]], [[Traits/Humanoid]], [[Traits/Orc]]

**Source** [[Sources/Advanced Player's Guide]] pg. 16
...
A common orc saying is, “You are the scars that shape you.” Violent, chaotic lives in violent, chaotic lands mean that most orcs tend heavily toward chaotic alignments. [[Setting/Deities/Gorum]], [[Setting/Deities/Lamashtu]], and [[Setting/Deities/Rovagug]] are all commonly worshiped among orc communities, though less violent holds worship nature deities like [[Setting/Deities/Gozreh]] or gods like [[Setting/Deities/Sarenrae]], whose tenets of fire, redemption, and glory all hold some appeal to orc sensibilities.
...
An orc's drive to overcome challenges and prove themself spurs many orcs to become adventurers, though orcs are more likely to set out on their own or with other orcs than alongside adventurers of other ancestries.
 ...
 Common orc backgrounds include [[Backgrounds/Gladiator|gladiator]], [[Backgrounds/Hunter|hunter]], [[Backgrounds/Martial Disciple|martial disciple]], [[Backgrounds/Nomad|nomad]], and [[Backgrounds/Warrior|warrior]] from the _Core Rulebook_, plus [[Backgrounds/Bandit|bandit]], [[Backgrounds/Outrider|outrider]], and [[Backgrounds/Refugee|refugee]] from this book. Orcs thrive in martial classes like [[Classes/Class Features/Ancestry and Background (Core Rulebook)|barbarian]] and [[Classes/Class Features/Ancestry and Background (class-feature-154)|fighter]].
...
### Orc History
 ...
 Originating deep underground, orcs were driven upward when the [[Ancestries/Dwarf|dwarves]] began their Quest for Sky. Endless dwarf forces advanced from below, crossing into orc territory and inciting a war that lasted for countless orc lifetimes, with each new generation losing more ground. When finally driven to the surface, orcs discovered a world shrouded by ash. The nearby [[Ancestries/Human|human]] civilizations were unprepared for their anger and desperation as they battled their way to empire with dauntless ferocity.

### Orc Holds

 Orc holds are large groups of orcs bound together by family, values, and loyalty.

**Burning Sun**: Armed with their faith in [[Setting/Deities/Sarenrae]], the Burning Sun hold is dedicated to directing orc culture toward a more righteous path.
...
[[Setting/Languages/Orcish]]

Additional languages equal to your Intelligence modifier (if it’s positive). Choose from [[Setting/Languages/Goblin]], [[Setting/Languages/Jotun]], [[Setting/Languages/Terran]], [[Setting/Languages/Undercommon]], and any other languages to which you have access (such as the languages prevalent in your region).
...
Source on Archives of Nethys: [Orc](https://2e.aonprd.com/Ancestries.aspx?ID=19)
