...
type: "ancestry"
aon_id: "ancestry-14"
aon_url: "https://2e.aonprd.com/Ancestries.aspx?ID=14"
tags:
  - pf2e/ancestry
  - rarity/uncommon
  - trait/leshy
...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=14"
  - "label Feats"
  - "url /Ancestries.aspx?ID=14/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=14/heritages"
...
**Traits** [[Traits/Uncommon]], [[Traits/Leshy]], [[Traits/Plant]]

**Source** [[Sources/Character Guide]] pg. 52
...
Some backgrounds are particularly suitable for adventuring leshies, especially those backgrounds with a tie to the natural world, such as [[Backgrounds/Hunter|hunter]], [[Backgrounds/Nomad|nomad]], or [[Backgrounds/Scout|scout]]. Nature-themed classes such as [[Classes/Class Features/Ancestry and Background (class-feature-129)|druid]] and [[Classes/Class Features/Ancestry and Background (class-feature-204)|ranger]] are popular choices for leshies. As druids, leshies gravitate toward the [[Classes/Subclasses/Druidic Orders/Leaf|leaf order]]. [[Classes/Class Features/Ancestry and Background (class-feature-55)|Bard]] is also a good fit for leshies with a love of storytelling; such leshies often inhabit vine leshy bodies.
...
Additional languages equal to your Intelligence modifier (if it's positive). Choose from [[Setting/Languages/Draconic]], [[Setting/Languages/Elven]], [[Setting/Languages/Gnomish]], [[Setting/Languages/Goblin]], [[Setting/Languages/Halfling]], [[Setting/Languages/Undercommon]], and any other languages to which you have access (such as the languages prevalent in your region).
...
You gain nourishment in the same way that the plants or fungi that match your body type normally do, through some combination of photosynthesis, absorbing minerals with your roots, or scavenging decaying matter. You typically do not need to pay for food. If you normally rely on photosynthesis and go without sunlight for 1 week, you begin to [[Rules/Starvation and Thirst|starve]]. You can derive nourishment from specially formulated bottles of sunlight instead of natural sunlight, but these bottles cost 10 times as much as standard rations (or 40 sp).

---

Source on Archives of Nethys: [Leshy](https://2e.aonprd.com/Ancestries.aspx?ID=14)
