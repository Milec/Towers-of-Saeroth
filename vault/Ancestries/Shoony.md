...
type: "ancestry"
aon_id: "ancestry-16"
aon_url: "https://2e.aonprd.com/Ancestries.aspx?ID=16"
tags:
  - pf2e/ancestry
  - rarity/rare
  - trait/humanoid
...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=16"
  - "label Feats"
  - "url /Ancestries.aspx?ID=16/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=16/heritages"
primary_source: "Pathfinder #153: Life's Long Shadows"
...
**Traits** [[Traits/Rare]], [[Traits/Humanoid]], [[Traits/Shoony]]

**Source** [[Sources/Pathfinder -153- Life's Long Shadows|Pathfinder #153: Life's Long Shadows]] pg. 70
...
Few shoonies willingly choose to leave their homeland and friends in favor of facing the unknown, and the circumstances that lead a shoony to adventure are often dramatic and life-altering, if not tragic. That said, some shoonies do travel the world in search of riches to bring back to their village or to avenge their kinfolk, and shoony adventurers who show bravery or ingenuity are sure to earn a place in the legends of their people.
 ...
 Typical shoonies have the [[Backgrounds/Acolyte|acolyte]], [[Backgrounds/Farmhand|farmhand]], [[Backgrounds/Hunter|hunter]], [[Backgrounds/Laborer|laborer]], or [[Backgrounds/Warrior|warrior]] backgrounds from the _Core Rulebook_, or the [[Backgrounds/Animal Wrangler|animal wrangler]] or [[Backgrounds/Rigger|rigger]] backgrounds from the _Extinction Curse Player’s Guide_. Many shoony adventurers are [[Classes/Class Features/Ancestry and Background (class-feature-154)|fighters]] who hone their skills to become stalwart defenders of their friends. Some shoonies pursue religious study and become [[Classes/Class Features/Ancestry and Background (class-feature-111)|clerics]] or [[Classes/Class Features/Ancestry and Background (class-feature-80)|champions]], while others develop their foraging and hunting skills as talented [[Classes/Class Features/Ancestry and Background (class-feature-129)|druids]] and [[Classes/Class Features/Ancestry and Background (class-feature-204)|rangers]].
...
[[Setting/Languages/Shoony]]

Additional languages equal to your Intelligence modifier (if it's positive). Choose from [[Setting/Languages/Dwarven]], [[Setting/Languages/Gnomish]], [[Setting/Languages/Goblin]], [[Setting/Languages/Halfling]], [[Setting/Languages/Terran]], and any other languages to which you have access (such as the languages prevalent in your region).
...
Your small, blunt snout and labyrinthine sinus system make you resistant to phenomena that assail the nose. When you roll a saving throw against [[Traits/Inhaled|inhaled]] threats (such as inhaled poisons) and [[Traits/Olfactory|olfactory]] effects (such as [[Bestiary/Families/Xulgath|xulgath stench]]), you get the outcome one degree of success better than the result of your roll.

---

Source on Archives of Nethys: [Shoony](https://2e.aonprd.com/Ancestries.aspx?ID=16)
