...
type: "ancestry"
aon_id: "ancestry-40"
aon_url: "https://2e.aonprd.com/Ancestries.aspx?ID=40"
tags:
  - pf2e/ancestry
  - rarity/rare
  - trait/humanoid
...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=40"
  - "label Feats"
  - "url /Ancestries.aspx?ID=40/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=40/heritages"
...
**Traits** [[Traits/Rare]], [[Traits/Humanoid]], [[Traits/Strix]]

**Source** [[Sources/Ancestry Guide]] pg. 132

__**PFS Note** As of May 2025, all Pathfinder Society characters have access to the strix ancestry.__
...
- Harbor an inherited distrust of [[Ancestries/Human|humans]].
...
Due to their deep respect for the rules of a functioning society, strix are rarely chaotic, but some may be flexible on adopting the rules of outside societies. Strix are typically nonreligious and instead use stories from an epic known as the Korrsat Akra, or “The Scattered Nest,” to tell them of their origins and give them direction on their current place in the world. They have a deep investment in the lives of their fellows and experience intense grief at their passing.
 ...
 [[Setting/Deities/Pharasma]] is a common influence among religious strix due to the popularity of religious and spiritual practices honoring the lives and deaths in their beloved community. [[Setting/Deities/Gozreh]] is also an everyday influence for many strix, who beseech the Wind and the Waves to give them satisfying tailwinds for flight and protect their kin when the sky turns dark with fury. [[Setting/Deities/Erastil]] and even [[Setting/Deities/Torag]] represent two versions of social order and may be unifying deities across entire tribes.

## Adventurers

Adventuring strix most commonly take the [[Backgrounds/Emissary|emissary]], [[Backgrounds/Hermit|hermit]], [[Backgrounds/Nomad|nomad]], [[Backgrounds/Scout|scout]], or [[Backgrounds/Street Urchin|street urchin]] backgrounds. Strix are agile combatants and prudent adventurers who excel as [[Classes/Class Features/Ancestry and Background (class-feature-129)|druids]], [[Classes/Class Features/Ancestry and Background (class-feature-154)|fighters]], [[Classes/Class Features/Ancestry and Background (class-feature-178)|monks]], [[Classes/Class Features/Ancestry and Background (class-feature-204)|rangers]], or [[Classes/Class Features/Ancestry and Background (class-feature-232)|rogues]].
...
[[Setting/Languages/Strix]]

Additional languages equal to your Intelligence modifier (if positive). Choose from [[Setting/Languages/Draconic]], [[Setting/Languages/Jotun]], [[Traits/Gnome]], [[Setting/Languages/Infernal]], and any other languages to which you have access (such as the languages prevalent in your region).

### Wings

All strix possess powerful wings. While not all strix focus on honing their flying skills, a strong flap of their wings allows strix to travel longer distances when jumping. When [[Actions/Leap|Leaping]] horizontally, you move an additional 5 feet. You don't automatically fail your checks to [[Actions/High Jump]] or [[Actions/Long Jump]] if you don't Stride at least 10 feet first. In addition, when you make a Long Jump, you can jump a distance up to 10 feet further than your [[Rules/Sidebars/Falling|Athletics]] check result, though still with the normal maximum of your Speed. Additionally, you take no damage from [[Rules/Falling|falling]], no matter what distance you fall.
...
Source on Archives of Nethys: [Strix](https://2e.aonprd.com/Ancestries.aspx?ID=40)
