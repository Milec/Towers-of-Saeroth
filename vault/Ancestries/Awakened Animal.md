...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=72"
  - "label Feats"
  - "url /Ancestries.aspx?ID=72/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=72/heritages"
primary_source: "Howl of the Wild"
...
**Traits** [[Traits/Rare]], [[Traits/Awakened Animal]], [[Traits/Beast]]

**Source** [[Sources/Howl of the Wild]] pg. 22

_Awakened animals were once normal creatures before they obtained sapience that gave them one paw in nature and the other in the world of cities and society. Almost any animal can be awakened, allowing for a wide variety of characters._
...
Awakened animals tend to see the world through a lens of natural order. Those who are unsettled by humans or have been traumatized by them typically live within nature, while those driven by curiosity or structure seek to find a place in the more ordered and rule-bound nature of humanoid society.
 ...
 There is no uniform religion among awakened animals, but it is unsurprising that gods with domains in the natural world, like [[Setting/Deities/Gozreh (Divine Mysteries)|Gozreh]], are popular. There are small groups of awakened animals who worship destructive gods such as [[Setting/Deities/Lamashtu (Divine Mysteries)|Lamashtu]] and [[Setting/Deities/Rovagug (Divine Mysteries)|Rovagug]]. Those who were awakened by a companion might adopt that companion's outlook, and possibly adopt that companion's religion as well.
...
### Animal Attacks
 ...
 Your heritage gives you a special [[Traits/Unarmed (Player Core)|unarmed]] attack instead of the [[Equipment/Weapons/Fist (Player Core)|fist]] unarmed attack humanoids typically gain. This attack is in the [[Equipment/Weapon Groups/Brawling|brawling]] weapon group. Work with your GM to determine which one you have, using the type of animal you are and suggestions in your heritage for guidance. For example, you might choose a beak, talon, or wing for an eagle, a fist or tail for a monkey, or a tongue or jaws for a toad.

##  

| Unarmed Attack | Damage | Traits |
| --- | --- | --- |
| Antler | 1d6 P | [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Beak | 1d6 P | [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Claw | 1d4 S | [[Traits/Agile (Player Core)|Agile]], [[Traits/Finesse (Player Core)|finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Fangs | 1d6 P | [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Fist | 1d4 B | [[Traits/Agile (Player Core)|Agile]], [[Traits/Finesse (Player Core)|finesse]], [[Traits/Nonlethal (Player Core)|nonlethal]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Horn | 1d6 P | [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Jaws | 1d6 P | [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Tail | 1d6 B | [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Trip (Player Core)|trip]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Talon | 1d4 P | [[Traits/Agile (Player Core)|Agile]], [[Traits/Finesse (Player Core)|finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Tongue | 1d6 B | [[Traits/Finesse (Player Core)|Finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
| Wing | 1d4 B | [[Traits/Agile (Player Core)|Agile]], [[Traits/Finesse (Player Core)|finesse]], [[Traits/Unarmed (Player Core)|unarmed]] |
...
Tiny or Small or Medium or Large
...
Awakening altered your mind. You are no longer an animal, but you can still ask questions of, receive answers from, and use the [[Rules/Skills/Diplomacy (Player Core)|Diplomacy]] skill with animals of your kind. By remembering your instincts, you can allow yourself to be affected by spells and other effects as though you were an [[Traits/Animal (Player Core)|animal]].

---

Source on Archives of Nethys: [Awakened Animal](https://2e.aonprd.com/Ancestries.aspx?ID=72)
