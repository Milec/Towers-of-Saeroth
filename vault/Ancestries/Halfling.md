...
type: "ancestry"
aon_id: "ancestry-5"
aon_url: "https://2e.aonprd.com/Ancestries.aspx?ID=5"
tags:
  - pf2e/ancestry
  - rarity/common
  - trait/halfling
...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=5"
  - "label Feats"
  - "url /Ancestries.aspx?ID=5/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=5/heritages"
...
**Traits** [[Traits/Halfling]], [[Traits/Humanoid]]

**Source** [[Sources/Core Rulebook]] pg. 50
...
Halflings' natural wanderlust and opportunistic nature make them ideal adventurers. Many people put up with their vivacious attitudes in return for the natural talents they provide and the popular superstition that traveling with a halfling is good luck.
 ...
 Typical backgrounds for halflings include [[Backgrounds/Acrobat|acrobat]], [[Backgrounds/Criminal|criminal]], [[Backgrounds/Emissary|emissary]], [[Backgrounds/Entertainer|entertainer]], [[Backgrounds/Laborer|laborer]], and [[Backgrounds/Street Urchin|street urchin]]. Halflings make great [[Classes/Class Features/Ancestry and Background (class-feature-111)|clerics]] and [[Classes/Class Features/Ancestry and Background (class-feature-232)|rogues]], but many also become [[Classes/Class Features/Ancestry and Background (class-feature-178)|monks]] or [[Classes/Class Features/Ancestry and Background (class-feature-204)|rangers]].
...
[[Setting/Languages/Halfling]]

Additional languages equal to your Intelligence modifier (if it's positive). Choose from [[Setting/Languages/Dwarven]], [[Setting/Languages/Elven]], [[Setting/Languages/Gnomish]], [[Setting/Languages/Goblin]], and any other languages to which you have access (such as the languages prevalent in your region).

### Keen Eyes

Your eyes are sharp, allowing you to make out small details about [[Rules/Conditions/Concealed|concealed]] or even [[Rules/Conditions/Invisible|invisible]] creatures that others might miss. You gain a +2 circumstance bonus when using the [[Actions/Seek]] action to find [[Rules/Conditions/Hidden|hidden]] or [[Rules/Conditions/Undetected|undetected]] creatures within 30 feet of you. When you target an opponent that is concealed from you or hidden from you, reduce the DC of the flat check to 3 for a concealed target or 9 for a hidden one.

---

Source on Archives of Nethys: [Halfling](https://2e.aonprd.com/Ancestries.aspx?ID=5)
