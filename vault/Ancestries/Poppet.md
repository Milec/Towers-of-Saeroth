...
type: "ancestry"
aon_id: "ancestry-49"
aon_url: "https://2e.aonprd.com/Ancestries.aspx?ID=49"
tags:
  - pf2e/ancestry
  - rarity/rare
  - trait/construct
...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=49"
  - "label Feats"
  - "url /Ancestries.aspx?ID=49/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=49/heritages"
primary_source: "Grand Bazaar"
...
**Traits** [[Traits/Rare]], [[Traits/Construct]], [[Traits/Humanoid]], [[Traits/Poppet]]

**Source** [[Sources/Grand Bazaar]] pg. 60

__**PFS Note** As of June 1, 2024, all Pathfinder Society agents have access to the poppet ancestry__
...
Ordinary poppets are built as helpers and companions, and awakened poppets tend to retain this drive to aid others. They're therefore generally good, and more poppets are lawful than chaotic. Some spend their time trying to uncover secrets of their creation, find others like them, or keep out of trouble; these poppets are generally neutral in alignment. Poppets aren't typically religious unless a particular faith defined their creation, such as being made from scraps of [[Setting/Deities/Iomedae|Iomedaean]] altar cloth or woven from reeds around a sacred [[Setting/Deities/Gozreh|Gozren]] pool. These poppets tend to be vocally religious, even zealous, in their faith. Poppets who find religion later in their lives often revere [[Setting/Deities/Brigh]], [[Setting/Deities/Casandalee]], or [[Setting/Deities/Nethys]].

## Adventurers

Poppets like helping others and experiencing new things; both of these motivations lead naturally into the life of an adventurer. They aren't generally driven by a lust for treasure, but they like adorning themselves with pretty accoutrement and using their finds to better the lives of others. The [[Backgrounds/Acolyte|acolyte]], [[Backgrounds/Entertainer|entertainer]], and [[Backgrounds/Laborer|laborer]] backgrounds are good choices for many poppets, as are [[Backgrounds/Cook|cook]], [[Backgrounds/Scavenger|scavenger]], and [[Backgrounds/Servant|servant]]. Poppets who watched their creator work might have the [[Backgrounds/Artist|artist]], [[Backgrounds/Hermit|hermit]], or [[Backgrounds/Tinker|tinker]] background to reflect what they've seen. Because poppets like to help others, they gravitate toward becoming [[Classes/Class Features/Ancestry and Background (class-feature-55)|bards]] or [[Classes/Class Features/Ancestry and Background (class-feature-80)|champions]]. Some might think that poppets' small size and general clumsiness make them poor [[Classes/Class Features/Ancestry and Background (class-feature-154)|fighters]] or [[Classes/Class Features/Ancestry and Background (class-feature-204)|rangers]], but certain poppets embrace these classes out of a drive to display their bravery and prove the naysayers wrong.
...
Additional languages equal to your Intelligence modifier (if positive). Choose from [[Setting/Languages/Draconic]], [[Setting/Languages/Dwarven]], [[Setting/Languages/Elven]], [[Setting/Languages/Gnomish]], [[Setting/Languages/Goblin]], [[Setting/Languages/Sylvan]], and any other languages to which you have access (such as the languages prevalent in your region).

### Constructed

The materials of your body resist ailments that assail the flesh. You gain a +1 circumstance bonus to saving throws against [[Traits/Death|death]] effects, [[Traits/Disease|disease]], and [[Traits/Poison|poison]] as well as to saving throws against effects that would give you the [[Rules/Conditions/Drained|drained]], [[Rules/Conditions/Paralyzed|paralyzed]], or [[Rules/Conditions/Sickened|sickened]] conditions. Your spark of life means that you're a living creature, and you can be healed by positive energy and harmed by negative energy as normal.
...
You have weakness to [[Traits/Fire|fire]] damage equal to one-third your level (minimum 1).

---

Source on Archives of Nethys: [Poppet](https://2e.aonprd.com/Ancestries.aspx?ID=49)
