...
type: "ancestry"
aon_id: "ancestry-32"
aon_url: "https://2e.aonprd.com/Ancestries.aspx?ID=32"
tags:
  - pf2e/ancestry
  - rarity/uncommon
  - trait/ganzi
...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=32"
  - "label Feats"
  - "url /Ancestries.aspx?ID=32/feats"
...
**Traits** [[Traits/Uncommon]], [[Traits/Ganzi]]

**Source** [[Sources/Ancestry Guide]] pg. 94
...
While some ganzis are born of mortals who mingled with the inchoate beings of the [[Rules/Sidebars/Galisemni|Maelstrom]], and some are descended from those who sailed that cerulean void, many others are born in places where the [[Setting/Planes/Material Plane]] frays toward chaos. Whatever their roots, all ganzis share the same potent essence.
...
- Assume you're related to [[Bestiary/Families/Protean|proteans]].

## Physical Description

While ganzis resemble other members of their ancestry, it's rare for chaos to manifest with any degree of subtlety. No two ganzis are wholly alike and there are no universal traits, yet there is more commonality among ganzis than a layperson might expect. While some ganzis have links to other creatures of chaos, like valkyries or einherji, and some to no known beings, a narrow majority manifest as “proteankin” ganzis. Whether actually related to [[Bestiary/Families/Protean|proteans]] or not, these ganzis possess serpentine tails with colorful scales and feathers, as well as patches of feather and scale in other places. Bilateral symmetry of such features is ubiquitous, despite their chaotic origins.
...
Unsurprisingly, ganzis lean heavily towards chaos, favoring organizations like the Firebrands. This is hardly universal, however—even a few suits of Hellknight armor accommodate a feathered serpent tail. Likewise, many ganzis find themselves suited to the service of [[Setting/Deities/Desna]], [[Setting/Deities/Cayden Cailean]], and other powers that value freedom and individuality.

## Adventurers

Ganzis come from all walks of life. Some find joy entertaining others and learn the skills of [[Backgrounds/Acrobat|acrobats]], [[Backgrounds/Entertainer|entertainers]], or [[Backgrounds/Gladiator|gladiators]]. Others focus on creative pursuits as [[Backgrounds/Artist|artists]] or [[Backgrounds/Tinker|tinkers]], or as [[Backgrounds/Charlatan|charlatans]]. The [[Classes/Class Features/Ancestry and Background (class-feature-232)|rogue]] and [[Classes/Class Features/Ancestry and Background (class-feature-55)|bard]] classes suit ganzis' love of chaos and mischief, while those looking for the thrill of combat often become [[Classes/Class Features/Ancestry and Background (class-feature-361)|swashbucklers]] or even liberator [[Classes/Class Features/Ancestry and Background (class-feature-80)|champions]]. Ganzis might study illusion magic as [[Classes/Class Features/Ancestry and Background (class-feature-282)|wizards]] or [[Classes/Class Features/Ancestry and Background (class-feature-392)|witches]].
...
## Ganzi Heritage Mechanics

Your blood is touched by primal chaos. You gain the [[Traits/Ganzi|ganzi]] trait in addition to the traits from your ancestry. You gain resistance to a single damage type equal to half your level; at the beginning of each day, determine randomly whether this resistance applies to acid, electricity, or sonic damage. You also gain a +1 circumstance bonus to saving throws against effects that would cause you to gain the [[Rules/Conditions/Controlled|controlled]] condition. You can choose from ganzi feats and feats from your ancestry whenever you gain an ancestry feat.

---

Source on Archives of Nethys: [Ganzi](https://2e.aonprd.com/Ancestries.aspx?ID=32)
