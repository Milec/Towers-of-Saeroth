...
navigation:
  - "label Details"
  - "url /Ancestries.aspx?ID=80"
  - "label Feats"
  - "url /Ancestries.aspx?ID=80/feats"
  - "label Heritages"
  - "url /Ancestries.aspx?ID=80/heritages"
...
**Traits** [[Traits/Uncommon (Player Core)|Uncommon]], [[Traits/Humanoid (Player Core)|Humanoid]], [[Traits/Kobold (Player Core 2)|Kobold]]

**Source** [[Sources/Player Core 2]] pg. 20

_Kobolds are small and reptilian, with features marked by the power they choose to follow._
...
All but the most iconoclastic kobolds have a natural respect for hierarchies and rules, relying on their ancestral social strategies for survival.
 ...
 Organized religion feels natural for most kobolds. They're often drawn to deities related to their benefactors, such as [[Setting/Deities/Asmodeus (Divine Mysteries)|Asmodeus]] if the benefactor is a devil, or dragon deities like [[Setting/Deities/Apsu]] and [[Setting/Deities/Dahak]] if the benefactor is a dragon. Kobolds also often find themselves drawn to cults, particularly those with powerful magical creatures as figureheads.
...
[[Setting/Languages/Sakvroth]]

Additional languages equal to your Intelligence modifier (if it's positive). Choose from [[Setting/Languages/Aklo (Player Core)|Aklo]], [[Setting/Languages/Diabolic]], [[Setting/Languages/Draconic (Player Core)|Draconic]], [[Setting/Languages/Dwarven (Player Core)|Dwarven]], [[Setting/Languages/Empyrean]], [[Setting/Languages/Fey]], [[Setting/Languages/Gnomish (Player Core)|Gnomish]], and [[Setting/Languages/Petran]], and any other languages to which you have access (such as the languages prevalent in your region).

### Darkvision

You can see in [[Rules/Darkness (Player Core)|darkness]] and [[Rules/Counteracting (Core Rulebook)|dim light]] just as well as you can see in [[Rules/Counteracting (Core Rulebook)|bright light]], though your vision in darkness is in black and white.

---

Source on Archives of Nethys: [Kobold](https://2e.aonprd.com/Ancestries.aspx?ID=80)
