...
**Source** [[Sources/Dark Archives (Remastered)]] pg. 124
...
**Disable**
DC 28 [[Rules/Skills/Thievery (Player Core)|Thievery]] (trained) to stabilize each wall, or [[Spells/Dispel Magic (Player Core)|_dispel magic_]] (4th level; [[Rules/Counteracting (rules-3280)|counteract]] DC 26) to counteract each wall

**Lose Form** ⤾ ([[Traits/Occult (Player Core)|occult]]) **Trigger** A creature reaches the hall's midpoint; **Effect** The hall's walls lose their rigidity, becoming fluid and elastic. The hall becomes [[Rules/Difficult Terrain (GM Core)|difficult terrain]], and each creature in the hall is knocked [[Rules/Conditions/Prone (Player Core)|prone]] unless they succeed at a DC 26 Reflex save. The trap then rolls initiative.
...
Source on Archives of Nethys: [Constricting Hall](https://2e.aonprd.com/Hazards.aspx?ID=639)
