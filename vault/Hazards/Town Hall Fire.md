...
type: "hazard"
aon_id: "hazard-63"
aon_url: "https://2e.aonprd.com/Hazards.aspx?ID=63"
tags:
  - pf2e/hazard
  - rarity/common
  - trait/complex
...
**Traits** [[Traits/Complex]], [[Traits/Environmental]], [[Traits/Fire]]

**Source** [[Sources/Pathfinder -145- Hellknight Hill|Pathfinder #145: Hellknight Hill]] pg. 9
...
**Disable**
Eliminating the hazard requires dousing the flames. Water typically clears a 5-foot square if the amount is small (such as that from [[Spells/Create Water|_create water_]] or [[Spells/Hydraulic Push|_hydraulic push_]]). Larger amounts of water, such as a full bucket, typically douse a 10-foot-by-10-foot area (or 4 squares in some other shape). Throwing a bucket of water on flames requires an Interact action. A [[Equipment/Waterskin|waterskin]] doesn't contain enough water to put out even 1 square of fire. [[Traits/Cold]] can also put out fire, but only if the cold can affect an area; cold is usually less effective than water, so a [[Equipment/Frost Vial|frost vial]] typically puts out 1 square of fire, and [[Spells/Ray of Frost|_ray of frost_]] is ineffective.
 ...
 **Turn 5** Spectators still inside the room fall [[Rules/Conditions/Unconscious|unconscious]] from burns and smoke inhalation.

 **Turn 7** Spectators still in the room die.

---

Source on Archives of Nethys: [Town Hall Fire](https://2e.aonprd.com/Hazards.aspx?ID=63)
