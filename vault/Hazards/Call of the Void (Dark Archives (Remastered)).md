...
**Traits** [[Traits/Unique (Player Core)|Unique]], [[Traits/Complex]], [[Traits/Environmental (GM Core)|Environmental]], [[Traits/Magical (Player Core)|Magical]]
...
**Disable**
DC 34 [[Rules/Skills/Occultism (Player Core)|Occultism]] or DC 36 [[Rules/Skills/Arcana (Player Core)|Arcana]] to expel the magical compulsion from the current island and from any of the red ropes directly attached to it, darkening the rope in color. The [[Bestiary/K.H.W.'S Echo (Dark Archives (Remastered))|Echo]] also automatically disables the hazard from any island he's standing on, and any of the red ropes directly attached to it, when he Reconstitutes from Thought on that island.

**Leap into the Unknown** ⤾ ([[Traits/Mental (Player Core)|mental]]) **Trigger** A creature enters a square adjacent to the ledge of an island or steps onto one of the red ropes; **Effect** The call of the void tugs at the mind of intruders, compelling them to leap off the ledge. The creature must succeed at a DC 34 Will save or DC 32 Acrobatics check to [[Actions/Balance (Player Core)|Balance]] or else drop off the ledge. If the creature falls off, it drops 100 feet, loops through the closed space of the mindscape, and lands in the square it fell from, taking falling damage as normal (usually 50 bludgeoning damage). The call of the void then rolls initiative.
...
Source on Archives of Nethys: [Call of the Void](https://2e.aonprd.com/Hazards.aspx?ID=644)
