...
type: "hazard"
aon_id: "hazard-11"
aon_url: "https://2e.aonprd.com/Hazards.aspx?ID=11"
tags:
  - pf2e/hazard
  - rarity/common
  - trait/magical
...
**Traits** [[Traits/Magical]], [[Traits/Mechanical]], [[Traits/Trap]]

**Source** [[Sources/Core Rulebook]] pg. 524
...
**Stealth**
DC 30 (or 0 if the trapdoor is disabled or broken) or [[Spells/Detect Magic|_detect magic_]]

**Disable**
[[Rules/Skills/Thievery]] DC 28 (trained) to remove the trapdoor
...
**Infinite Pitfall** ⤾ **Trigger** A creature walks onto the trapdoor. **Effect** The triggering creature falls in and continues to fall, potentially forever. That creature can try to [[Actions/Grab an Edge]] to avoid [[Rules/Falling|falling]]. The DC to [[Actions/Climb]] the walls or Grab an Edge is 26.
...
Source on Archives of Nethys: [Bottomless Pit](https://2e.aonprd.com/Hazards.aspx?ID=11)
